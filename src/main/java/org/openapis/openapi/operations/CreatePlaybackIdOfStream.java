...
public class CreatePlaybackIdOfStream {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePlaybackIdOfStreamRequest, org.openapis.openapi.models.operations.async.CreatePlaybackIdOfStreamResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.CreatePlaybackIdOfStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.CreatePlaybackIdOfStreamResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.CreatePlaybackIdOfStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.CreatePlaybackIdOfStreamResponse res = resBuilder.build();
