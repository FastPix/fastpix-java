...
import org.openapis.openapi.models.components.CreateMediaSuccessResponse;
...
public class CreateMedia {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMediaRequest, org.openapis.openapi.models.operations.async.CreateMediaResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.CreateMediaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.CreateMediaResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.CreateMediaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.CreateMediaResponse res = resBuilder.build();
