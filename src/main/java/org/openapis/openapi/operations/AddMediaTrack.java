...
import org.openapis.openapi.models.operations.AddMediaTrackResponseBody;
...
public class AddMediaTrack {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddMediaTrackRequest, org.openapis.openapi.models.operations.async.AddMediaTrackResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.AddMediaTrackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.AddMediaTrackResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.AddMediaTrackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.AddMediaTrackResponse res = resBuilder.build();
