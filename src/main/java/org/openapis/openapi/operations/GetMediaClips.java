...
public class GetMediaClips {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMediaClipsRequest, org.openapis.openapi.models.operations.async.GetMediaClipsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetMediaClipsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetMediaClipsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetMediaClipsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetMediaClipsResponse res = resBuilder.build();
