...
public class CreateNewStream {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateLiveStreamRequest, org.openapis.openapi.models.operations.async.CreateNewStreamResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.CreateNewStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.CreateNewStreamResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.CreateNewStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.CreateNewStreamResponse res = resBuilder.build();
