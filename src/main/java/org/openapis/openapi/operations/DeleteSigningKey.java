...
public class DeleteSigningKey {
        ...
        public DeleteSigningKeyResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDeleteSigningKeyResponse(Utils.unmarshal(response, new TypeReference<org.openapis.openapi.models.components.DeleteSigningKeyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteSigningKeyRequest, org.openapis.openapi.models.operations.async.DeleteSigningKeyResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteSigningKeyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteSigningKeyResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteSigningKeyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteSigningKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<org.openapis.openapi.models.components.DeleteSigningKeyResponse>() {})
