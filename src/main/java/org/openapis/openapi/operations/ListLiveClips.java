...
public class ListLiveClips {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLiveClipsRequest, org.openapis.openapi.models.operations.async.ListLiveClipsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.ListLiveClipsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.ListLiveClipsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.ListLiveClipsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.ListLiveClipsResponse res = resBuilder.build();
