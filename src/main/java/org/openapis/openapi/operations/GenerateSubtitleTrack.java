...
public class GenerateSubtitleTrack {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GenerateSubtitleTrackRequest, org.openapis.openapi.models.operations.async.GenerateSubtitleTrackResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GenerateSubtitleTrackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GenerateSubtitleTrackResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GenerateSubtitleTrackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GenerateSubtitleTrackResponse res = resBuilder.build();
