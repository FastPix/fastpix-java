...
public class AddMediaToPlaylist {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddMediaToPlaylistRequest, org.openapis.openapi.models.operations.async.AddMediaToPlaylistResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.AddMediaToPlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.AddMediaToPlaylistResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.AddMediaToPlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.AddMediaToPlaylistResponse res = resBuilder.build();
