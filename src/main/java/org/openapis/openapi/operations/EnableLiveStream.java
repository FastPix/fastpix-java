...
public class EnableLiveStream {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EnableLiveStreamRequest, org.openapis.openapi.models.operations.async.EnableLiveStreamResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.EnableLiveStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.EnableLiveStreamResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.EnableLiveStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.EnableLiveStreamResponse res = resBuilder.build();
