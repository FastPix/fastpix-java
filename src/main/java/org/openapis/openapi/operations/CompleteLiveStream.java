...
public class CompleteLiveStream {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CompleteLiveStreamRequest, org.openapis.openapi.models.operations.async.CompleteLiveStreamResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.CompleteLiveStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.CompleteLiveStreamResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.CompleteLiveStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.CompleteLiveStreamResponse res = resBuilder.build();
