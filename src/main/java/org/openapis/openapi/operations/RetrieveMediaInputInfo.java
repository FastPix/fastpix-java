...
import org.openapis.openapi.models.operations.RetrieveMediaInputInfoResponseBody;
...
public class RetrieveMediaInputInfo {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RetrieveMediaInputInfoRequest, org.openapis.openapi.models.operations.async.RetrieveMediaInputInfoResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.RetrieveMediaInputInfoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.RetrieveMediaInputInfoResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.RetrieveMediaInputInfoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.RetrieveMediaInputInfoResponse res = resBuilder.build();
