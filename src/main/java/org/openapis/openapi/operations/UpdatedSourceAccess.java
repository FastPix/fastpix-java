...
import org.openapis.openapi.models.operations.UpdatedSourceAccessResponseBody;
...
public class UpdatedSourceAccess {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatedSourceAccessRequest, org.openapis.openapi.models.operations.async.UpdatedSourceAccessResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.UpdatedSourceAccessResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.UpdatedSourceAccessResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.UpdatedSourceAccessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.UpdatedSourceAccessResponse res = resBuilder.build();
