...
public class GetAllPlaylists {
        ...
        public GetAllPlaylistsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withGetAllPlaylistsResponse(Utils.unmarshal(response, new TypeReference<org.openapis.openapi.models.components.GetAllPlaylistsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllPlaylistsRequest, org.openapis.openapi.models.operations.async.GetAllPlaylistsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetAllPlaylistsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetAllPlaylistsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetAllPlaylistsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetAllPlaylistsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<org.openapis.openapi.models.components.GetAllPlaylistsResponse>() {})
