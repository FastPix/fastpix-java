...
import io.fastpix.sdk.hooks.SDKHooks;
import io.fastpix.sdk.utils.AsyncHooks;
import io.fastpix.sdk.utils.HTTPClient;
import io.fastpix.sdk.utils.Hooks;
...
public class SDKConfiguration {
    ...
    public static final String USER_AGENT =
            String.format("fastpix-sdk/%s %s %s %s",
                LANGUAGE, SDK_VERSION, OPENAPI_DOC_VERSION, BASE_PACKAGE);
    ...
    private HTTPClient client = new FastpixHTTPClient();
