...
import io.fastpix.sdk.models.operations.CancelUploadResponseBody;
...
public final class CancelUpload {

    private static final String OPERATION_ID = "cancel-upload";
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelUploadRequest, CancelUploadResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CancelUploadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelUploadRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelUploadRequest request) {
        ...
        @Override
        public CancelUploadResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CancelUploadResponse.Builder resBuilder =
            ...
            CancelUploadResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<CancelUploadResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CancelUploadRequest, io.fastpix.sdk.models.operations.async.CancelUploadResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelUploadRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelUploadRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelUploadRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.CancelUploadResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.CancelUploadResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.CancelUploadResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.CancelUploadResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<CancelUploadResponseBody>() {})
