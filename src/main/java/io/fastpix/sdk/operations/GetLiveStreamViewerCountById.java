...
import io.fastpix.sdk.models.components.ViewsCountResponse;
import io.fastpix.sdk.models.errors.APIException;
import io.fastpix.sdk.models.operations.GetLiveStreamViewerCountByIdRequest;
...
public final class GetLiveStreamViewerCountById {

    private static final String OPERATION_ID = "get-live-stream-viewer-count-by-id";
    ...
    private GetLiveStreamViewerCountById() {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLiveStreamViewerCountByIdRequest, GetLiveStreamViewerCountByIdResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetLiveStreamViewerCountByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLiveStreamViewerCountByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLiveStreamViewerCountByIdRequest request) {
        ...
        @Override
        public GetLiveStreamViewerCountByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLiveStreamViewerCountByIdResponse.Builder resBuilder =
            ...
            GetLiveStreamViewerCountByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withViewsCountResponse(Utils.unmarshal(response, new TypeReference<ViewsCountResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLiveStreamViewerCountByIdRequest, io.fastpix.sdk.models.operations.async.GetLiveStreamViewerCountByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLiveStreamViewerCountByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLiveStreamViewerCountByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLiveStreamViewerCountByIdRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetLiveStreamViewerCountByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetLiveStreamViewerCountByIdResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetLiveStreamViewerCountByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetLiveStreamViewerCountByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<ViewsCountResponse>() {})
                            .thenApply(res::withViewsCountResponse);
                } else {
