...
public final class UpdatedMedia {
    ...
    private static final String OPERATION_ID = "updated-media";
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatedMediaRequest, UpdatedMediaResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdatedMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatedMediaRequest.class, new TypeReference<UpdatedMediaRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatedMediaRequest request) {
        ...
        @Override
        public UpdatedMediaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatedMediaResponse.Builder resBuilder =
            ...
            UpdatedMediaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdatedMediaResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatedMediaRequest, io.fastpix.sdk.models.operations.async.UpdatedMediaResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdatedMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatedMediaRequest.class, new TypeReference<UpdatedMediaRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatedMediaRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdatedMediaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdatedMediaResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdatedMediaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdatedMediaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdatedMediaResponseBody>() {})
