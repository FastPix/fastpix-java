...
import io.fastpix.sdk.models.components.CreateMediaSuccessResponse;
...
public class CreateMedia {
    ...
    private static final String OPERATION_ID = "create-media";
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMediaRequest, CreateMediaResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateMediaRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMediaRequest request) {
        ...
        @Override
        public CreateMediaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMediaResponse.Builder resBuilder =
                    CreateMediaResponse
                            .builder()
            ...
            CreateMediaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withCreateMediaSuccessResponse(Utils.unmarshal(response, new TypeReference<CreateMediaSuccessResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMediaRequest, io.fastpix.sdk.models.operations.async.CreateMediaResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreateMediaRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMediaRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.CreateMediaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.CreateMediaResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.CreateMediaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.CreateMediaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateMediaSuccessResponse>() {})
                            .thenApply(res::withCreateMediaSuccessResponse);
                } else {
