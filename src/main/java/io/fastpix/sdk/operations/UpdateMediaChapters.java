...
import io.fastpix.sdk.models.operations.UpdateMediaChaptersResponseBody;
...
public final class UpdateMediaChapters {

    private static final String OPERATION_ID = "update-media-chapters";
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMediaChaptersRequest, UpdateMediaChaptersResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateMediaChaptersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMediaChaptersRequest.class, new TypeReference<UpdateMediaChaptersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMediaChaptersRequest request) {
        ...
        @Override
        public UpdateMediaChaptersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMediaChaptersResponse.Builder resBuilder =
            ...
            UpdateMediaChaptersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdateMediaChaptersResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMediaChaptersRequest, io.fastpix.sdk.models.operations.async.UpdateMediaChaptersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMediaChaptersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMediaChaptersRequest.class, new TypeReference<UpdateMediaChaptersRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMediaChaptersRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdateMediaChaptersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdateMediaChaptersResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdateMediaChaptersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdateMediaChaptersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateMediaChaptersResponseBody>() {})
