...
public final class UpdateLiveStream {
    ...
    private static final String OPERATION_ID = "update-live-stream";
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLiveStreamRequest, UpdateLiveStreamResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateLiveStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLiveStreamRequest.class, new TypeReference<UpdateLiveStreamRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLiveStreamRequest request) {
        ...
        @Override
        public UpdateLiveStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLiveStreamResponse.Builder resBuilder =
            ...
            UpdateLiveStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withPatchResponseDTO(Utils.unmarshal(response, new TypeReference<PatchResponseDTO>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLiveStreamRequest, io.fastpix.sdk.models.operations.async.UpdateLiveStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLiveStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLiveStreamRequest.class, new TypeReference<UpdateLiveStreamRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLiveStreamRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdateLiveStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdateLiveStreamResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdateLiveStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdateLiveStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<PatchResponseDTO>() {})
                            .thenApply(res::withPatchResponseDTO);
                } else {
