...
import io.fastpix.sdk.models.operations.ListErrorsResponseBody;
...
public class ListErrors {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListErrorsRequest, ListErrorsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListErrorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListErrorsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListErrorsRequest request) {
        ...
        @Override
        public ListErrorsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListErrorsResponse.Builder resBuilder =
                    ListErrorsResponse
                            .builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListErrorsRequest, io.fastpix.sdk.models.operations.async.ListErrorsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListErrorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListErrorsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListErrorsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListErrorsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListErrorsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListErrorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
