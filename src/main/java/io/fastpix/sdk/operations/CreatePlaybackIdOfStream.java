...
public class CreatePlaybackIdOfStream {

    private static final String OPERATION_ID = "create-playbackId-of-stream";
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePlaybackIdOfStreamRequest, CreatePlaybackIdOfStreamResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreatePlaybackIdOfStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePlaybackIdOfStreamRequest.class, new TypeReference<CreatePlaybackIdOfStreamRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePlaybackIdOfStreamRequest request) {
        ...
        @Override
        public CreatePlaybackIdOfStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreatePlaybackIdOfStreamResponse.Builder resBuilder =
            ...
            CreatePlaybackIdOfStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withPlaybackIdSuccessResponse(Utils.unmarshal(response, new TypeReference<PlaybackIdSuccessResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePlaybackIdOfStreamRequest, io.fastpix.sdk.models.operations.async.CreatePlaybackIdOfStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreatePlaybackIdOfStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreatePlaybackIdOfStreamRequest.class, new TypeReference<CreatePlaybackIdOfStreamRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePlaybackIdOfStreamRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.CreatePlaybackIdOfStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.CreatePlaybackIdOfStreamResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.CreatePlaybackIdOfStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.CreatePlaybackIdOfStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlaybackIdSuccessResponse>() {})
                            .thenApply(res::withPlaybackIdSuccessResponse);
                } else {
