...
import io.fastpix.sdk.models.operations.GetDrmConfigurationResponseBody;
...
public final class GetDrmConfiguration {

    private static final String OPERATION_ID = "getDrmConfiguration";
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDrmConfigurationRequest, GetDrmConfigurationResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDrmConfigurationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDrmConfigurationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDrmConfigurationRequest request) {
        ...
        @Override
        public GetDrmConfigurationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDrmConfigurationResponse.Builder resBuilder =
            ...
            GetDrmConfigurationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetDrmConfigurationResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDrmConfigurationRequest, io.fastpix.sdk.models.operations.async.GetDrmConfigurationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDrmConfigurationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDrmConfigurationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDrmConfigurationRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetDrmConfigurationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetDrmConfigurationResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetDrmConfigurationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetDrmConfigurationResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDrmConfigurationResponseBody>() {})
