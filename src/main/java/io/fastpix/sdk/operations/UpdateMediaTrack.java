...
import io.fastpix.sdk.models.operations.UpdateMediaTrackResponseBody;
...
public final class UpdateMediaTrack {

    private static final String OPERATION_ID = "update-media-track";
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMediaTrackRequest, UpdateMediaTrackResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateMediaTrackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMediaTrackRequest.class, new TypeReference<UpdateMediaTrackRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMediaTrackRequest request) {
        ...
        @Override
        public UpdateMediaTrackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMediaTrackResponse.Builder resBuilder =
            ...
            UpdateMediaTrackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdateMediaTrackResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMediaTrackRequest, io.fastpix.sdk.models.operations.async.UpdateMediaTrackResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMediaTrackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMediaTrackRequest.class, new TypeReference<UpdateMediaTrackRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMediaTrackRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdateMediaTrackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdateMediaTrackResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdateMediaTrackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdateMediaTrackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateMediaTrackResponseBody>() {})
