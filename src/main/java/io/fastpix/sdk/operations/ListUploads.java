...
import io.fastpix.sdk.models.operations.ListUploadsResponseBody;
...
public final class ListUploads {

    private static final String OPERATION_ID = "list-uploads";
    ...
    public static class Sync extends Base
            implements RequestOperation<ListUploadsRequest, ListUploadsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListUploadsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUploadsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUploadsRequest request) {
        ...
        @Override
        public ListUploadsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListUploadsResponse.Builder resBuilder =
                    ListUploadsResponse
                            .builder()
            ...
            ListUploadsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListUploadsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUploadsRequest, io.fastpix.sdk.models.operations.async.ListUploadsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListUploadsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUploadsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUploadsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListUploadsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListUploadsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListUploadsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ListUploadsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListUploadsResponseBody>() {})
