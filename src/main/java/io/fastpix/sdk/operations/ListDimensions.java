...
import io.fastpix.sdk.models.operations.ListDimensionsResponseBody;
...
public final class ListDimensions {
    ...
    private static final String OPERATION_ID = "list_dimensions";
    ...
    public static class Sync extends Base
            implements RequestlessOperation<ListDimensionsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        @Override
        public ListDimensionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListDimensionsResponse.Builder resBuilder =
            ...
            ListDimensionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListDimensionsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<io.fastpix.sdk.models.operations.async.ListDimensionsResponse> {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListDimensionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListDimensionsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListDimensionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ListDimensionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListDimensionsResponseBody>() {})
