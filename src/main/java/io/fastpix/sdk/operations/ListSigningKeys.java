...
import io.fastpix.sdk.models.components.GetAllSigningKeysResponse;
import io.fastpix.sdk.models.errors.APIException;
import io.fastpix.sdk.models.operations.ListSigningKeysRequest;
import io.fastpix.sdk.models.operations.ListSigningKeysResponse;
...
public final class ListSigningKeys {

    private static final String OPERATION_ID = "list_signing_keys";
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSigningKeysRequest, ListSigningKeysResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListSigningKeysRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningKeysRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSigningKeysRequest request) {
        ...
        @Override
        public ListSigningKeysResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSigningKeysResponse.Builder resBuilder =
            ...
            ListSigningKeysResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withGetAllSigningKeysResponse(Utils.unmarshal(response, new TypeReference<GetAllSigningKeysResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSigningKeysRequest, io.fastpix.sdk.models.operations.async.ListSigningKeysResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSigningKeysRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSigningKeysRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSigningKeysRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListSigningKeysResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListSigningKeysResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListSigningKeysResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ListSigningKeysResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetAllSigningKeysResponse>() {})
                            .thenApply(res::withGetAllSigningKeysResponse);
                } else {
