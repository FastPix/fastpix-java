...
import io.fastpix.sdk.models.operations.UpdatedMp4SupportResponseBody;
...
public final class UpdatedMp4Support {

    private static final String OPERATION_ID = "updated-mp4Support";
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatedMp4SupportRequest, UpdatedMp4SupportResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdatedMp4SupportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatedMp4SupportRequest.class, new TypeReference<UpdatedMp4SupportRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatedMp4SupportRequest request) {
        ...
        @Override
        public UpdatedMp4SupportResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatedMp4SupportResponse.Builder resBuilder =
            ...
            UpdatedMp4SupportResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdatedMp4SupportResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatedMp4SupportRequest, io.fastpix.sdk.models.operations.async.UpdatedMp4SupportResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdatedMp4SupportRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatedMp4SupportRequest.class, new TypeReference<UpdatedMp4SupportRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatedMp4SupportRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdatedMp4SupportResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdatedMp4SupportResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdatedMp4SupportResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdatedMp4SupportResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdatedMp4SupportResponseBody>() {})
