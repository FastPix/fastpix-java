...
public final class GetSpecificSimulcastOfStream {

    private static final String OPERATION_ID = "get-specific-simulcast-of-stream";
    ...
    private GetSpecificSimulcastOfStream() {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSpecificSimulcastOfStreamRequest, GetSpecificSimulcastOfStreamResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSpecificSimulcastOfStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSpecificSimulcastOfStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSpecificSimulcastOfStreamRequest request) {
        ...
        @Override
        public GetSpecificSimulcastOfStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSpecificSimulcastOfStreamResponse.Builder resBuilder =
            ...
            GetSpecificSimulcastOfStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withSimulcastResponse(Utils.unmarshal(response, new TypeReference<SimulcastResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSpecificSimulcastOfStreamRequest, io.fastpix.sdk.models.operations.async.GetSpecificSimulcastOfStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSpecificSimulcastOfStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSpecificSimulcastOfStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSpecificSimulcastOfStreamRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetSpecificSimulcastOfStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetSpecificSimulcastOfStreamResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetSpecificSimulcastOfStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetSpecificSimulcastOfStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<SimulcastResponse>() {})
                            .thenApply(res::withSimulcastResponse);
                } else {
