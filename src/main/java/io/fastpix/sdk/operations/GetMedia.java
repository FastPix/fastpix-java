...
public final class GetMedia {
    ...
    private static final String OPERATION_ID = "get-media";
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMediaRequest, GetMediaResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMediaRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMediaRequest request) {
        ...
        @Override
        public GetMediaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMediaResponse.Builder resBuilder =
                    GetMediaResponse
                            .builder()
            ...
            GetMediaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetMediaResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMediaRequest, io.fastpix.sdk.models.operations.async.GetMediaResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMediaRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMediaRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetMediaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetMediaResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetMediaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetMediaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetMediaResponseBody>() {})
