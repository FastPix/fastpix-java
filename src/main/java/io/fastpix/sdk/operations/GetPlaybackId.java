...
import io.fastpix.sdk.models.operations.GetPlaybackIdResponseBody;
...
public final class GetPlaybackId {

    private static final String OPERATION_ID = "get-playback-id";
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPlaybackIdRequest, GetPlaybackIdResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPlaybackIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaybackIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPlaybackIdRequest request) {
        ...
        @Override
        public GetPlaybackIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPlaybackIdResponse.Builder resBuilder =
            ...
            GetPlaybackIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetPlaybackIdResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPlaybackIdRequest, io.fastpix.sdk.models.operations.async.GetPlaybackIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPlaybackIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaybackIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPlaybackIdRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetPlaybackIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetPlaybackIdResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetPlaybackIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetPlaybackIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPlaybackIdResponseBody>() {})
