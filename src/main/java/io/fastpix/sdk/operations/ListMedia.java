...
public final class ListMedia {

    private static final String OPERATION_ID = "list-media";
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMediaRequest, ListMediaResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMediaRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMediaRequest request) {
        ...
        @Override
        public ListMediaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMediaResponse.Builder resBuilder =
                    ListMediaResponse
                            .builder()
            ...
            ListMediaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListMediaResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMediaRequest, io.fastpix.sdk.models.operations.async.ListMediaResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMediaRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMediaRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListMediaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListMediaResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListMediaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ListMediaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListMediaResponseBody>() {})
