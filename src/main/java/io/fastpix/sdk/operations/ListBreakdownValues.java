...
import io.fastpix.sdk.models.operations.ListBreakdownValuesResponseBody;
...
public final class ListBreakdownValues {

    private static final String OPERATION_ID = "list_breakdown_values";
    ...
    public static class Sync extends Base
            implements RequestOperation<ListBreakdownValuesRequest, ListBreakdownValuesResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListBreakdownValuesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBreakdownValuesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBreakdownValuesRequest request) {
        ...
        @Override
        public ListBreakdownValuesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListBreakdownValuesResponse.Builder resBuilder =
            ...
            ListBreakdownValuesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListBreakdownValuesResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListBreakdownValuesRequest, io.fastpix.sdk.models.operations.async.ListBreakdownValuesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListBreakdownValuesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBreakdownValuesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListBreakdownValuesRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListBreakdownValuesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListBreakdownValuesResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListBreakdownValuesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ListBreakdownValuesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListBreakdownValuesResponseBody>() {})
