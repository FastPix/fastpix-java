...
public final class UpdateAPlaylist {

    private static final String OPERATION_ID = "update-a-playlist";
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAPlaylistRequest, UpdateAPlaylistResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateAPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAPlaylistRequest.class, new TypeReference<UpdateAPlaylistRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAPlaylistRequest request) {
        ...
        @Override
        public UpdateAPlaylistResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAPlaylistResponse.Builder resBuilder =
            ...
            UpdateAPlaylistResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withPlaylistCreatedResponse(Utils.unmarshal(response, new TypeReference<PlaylistCreatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAPlaylistRequest, io.fastpix.sdk.models.operations.async.UpdateAPlaylistResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAPlaylistRequest.class, new TypeReference<UpdateAPlaylistRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAPlaylistRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdateAPlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdateAPlaylistResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdateAPlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdateAPlaylistResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlaylistCreatedResponse>() {})
                            .thenApply(res::withPlaylistCreatedResponse);
                } else {
