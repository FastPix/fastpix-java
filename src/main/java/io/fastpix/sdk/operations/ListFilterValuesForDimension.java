...
import io.fastpix.sdk.models.operations.ListFilterValuesForDimensionResponseBody;
...
public final class ListFilterValuesForDimension {

    private static final String OPERATION_ID = "list_filter_values_for_dimension";
    ...
    private ListFilterValuesForDimension() {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListFilterValuesForDimensionRequest, ListFilterValuesForDimensionResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListFilterValuesForDimensionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListFilterValuesForDimensionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListFilterValuesForDimensionRequest request) {
        ...
        @Override
        public ListFilterValuesForDimensionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListFilterValuesForDimensionResponse.Builder resBuilder =
            ...
            ListFilterValuesForDimensionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListFilterValuesForDimensionResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListFilterValuesForDimensionRequest, io.fastpix.sdk.models.operations.async.ListFilterValuesForDimensionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListFilterValuesForDimensionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListFilterValuesForDimensionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListFilterValuesForDimensionRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListFilterValuesForDimensionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListFilterValuesForDimensionResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListFilterValuesForDimensionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ListFilterValuesForDimensionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListFilterValuesForDimensionResponseBody>() {})
