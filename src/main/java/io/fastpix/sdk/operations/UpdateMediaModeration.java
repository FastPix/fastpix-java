...
import io.fastpix.sdk.models.operations.UpdateMediaModerationResponseBody;
...
public class UpdateMediaModeration {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMediaModerationRequest, UpdateMediaModerationResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateMediaModerationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMediaModerationRequest.class, new TypeReference<UpdateMediaModerationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMediaModerationRequest request) {
        ...
        @Override
        public UpdateMediaModerationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMediaModerationResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMediaModerationRequest, io.fastpix.sdk.models.operations.async.UpdateMediaModerationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMediaModerationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMediaModerationRequest.class, new TypeReference<UpdateMediaModerationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMediaModerationRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdateMediaModerationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdateMediaModerationResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdateMediaModerationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
