...
import io.fastpix.sdk.models.operations.ListComparisonValuesResponseBody;
...
public final class ListComparisonValues {

    private static final String OPERATION_ID = "list_comparison_values";
    ...
    public static class Sync extends Base
            implements RequestOperation<ListComparisonValuesRequest, ListComparisonValuesResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListComparisonValuesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListComparisonValuesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListComparisonValuesRequest request) {
        ...
        @Override
        public ListComparisonValuesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListComparisonValuesResponse.Builder resBuilder =
            ...
            ListComparisonValuesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListComparisonValuesResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListComparisonValuesRequest, io.fastpix.sdk.models.operations.async.ListComparisonValuesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListComparisonValuesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListComparisonValuesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListComparisonValuesRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListComparisonValuesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListComparisonValuesResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListComparisonValuesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ListComparisonValuesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListComparisonValuesResponseBody>() {})
