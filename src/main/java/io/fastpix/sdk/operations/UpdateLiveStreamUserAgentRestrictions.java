...
public final class UpdateLiveStreamUserAgentRestrictions {

    private static final String OPERATION_ID = "update-live-stream-user-agent-restrictions";
    ...
    private UpdateLiveStreamUserAgentRestrictions() {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLiveStreamUserAgentRestrictionsRequest, UpdateLiveStreamUserAgentRestrictionsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateLiveStreamUserAgentRestrictionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLiveStreamUserAgentRestrictionsRequest.class, new TypeReference<UpdateLiveStreamUserAgentRestrictionsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLiveStreamUserAgentRestrictionsRequest request) {
        ...
        @Override
        public UpdateLiveStreamUserAgentRestrictionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLiveStreamUserAgentRestrictionsResponse.Builder resBuilder =
            ...
            UpdateLiveStreamUserAgentRestrictionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdateLiveStreamUserAgentRestrictionsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLiveStreamUserAgentRestrictionsRequest, io.fastpix.sdk.models.operations.async.UpdateLiveStreamUserAgentRestrictionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLiveStreamUserAgentRestrictionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLiveStreamUserAgentRestrictionsRequest.class, new TypeReference<UpdateLiveStreamUserAgentRestrictionsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLiveStreamUserAgentRestrictionsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdateLiveStreamUserAgentRestrictionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdateLiveStreamUserAgentRestrictionsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdateLiveStreamUserAgentRestrictionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdateLiveStreamUserAgentRestrictionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateLiveStreamUserAgentRestrictionsResponseBody>() {})
