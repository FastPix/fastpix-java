...
import io.fastpix.sdk.models.operations.ListByTopContentResponseBody;
...
public final class ListByTopContent {

    private static final String OPERATION_ID = "list_by_top_content";
    ...
    public static class Sync extends Base
            implements RequestOperation<ListByTopContentRequest, ListByTopContentResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListByTopContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListByTopContentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListByTopContentRequest request) {
        ...
        @Override
        public ListByTopContentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListByTopContentResponse.Builder resBuilder =
            ...
            ListByTopContentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListByTopContentResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListByTopContentRequest, io.fastpix.sdk.models.operations.async.ListByTopContentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListByTopContentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListByTopContentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListByTopContentRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListByTopContentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListByTopContentResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListByTopContentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ListByTopContentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListByTopContentResponseBody>() {})
