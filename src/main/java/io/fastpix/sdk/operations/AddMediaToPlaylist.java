...
public final class AddMediaToPlaylist {

    private static final String OPERATION_ID = "add-media-to-playlist";
    ...
    public static class Sync extends Base
            implements RequestOperation<AddMediaToPlaylistRequest, AddMediaToPlaylistResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddMediaToPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddMediaToPlaylistRequest.class, new TypeReference<AddMediaToPlaylistRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddMediaToPlaylistRequest request) {
        ...
        @Override
        public AddMediaToPlaylistResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddMediaToPlaylistResponse.Builder resBuilder =
            ...
            AddMediaToPlaylistResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddMediaToPlaylistRequest, io.fastpix.sdk.models.operations.async.AddMediaToPlaylistResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddMediaToPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddMediaToPlaylistRequest.class, new TypeReference<AddMediaToPlaylistRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddMediaToPlaylistRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.AddMediaToPlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.AddMediaToPlaylistResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.AddMediaToPlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.AddMediaToPlaylistResponse res = resBuilder.build();
