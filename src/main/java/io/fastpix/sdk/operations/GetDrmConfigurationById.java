...
import io.fastpix.sdk.models.operations.GetDrmConfigurationByIdResponseBody;
...
public final class GetDrmConfigurationById {

    private static final String OPERATION_ID = "getDrmConfigurationById";
    ...
    private GetDrmConfigurationById() {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetDrmConfigurationByIdRequest, GetDrmConfigurationByIdResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetDrmConfigurationByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDrmConfigurationByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetDrmConfigurationByIdRequest request) {
        ...
        @Override
        public GetDrmConfigurationByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetDrmConfigurationByIdResponse.Builder resBuilder =
            ...
            GetDrmConfigurationByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetDrmConfigurationByIdResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetDrmConfigurationByIdRequest, io.fastpix.sdk.models.operations.async.GetDrmConfigurationByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetDrmConfigurationByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetDrmConfigurationByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetDrmConfigurationByIdRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetDrmConfigurationByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetDrmConfigurationByIdResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetDrmConfigurationByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetDrmConfigurationByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetDrmConfigurationByIdResponseBody>() {})
