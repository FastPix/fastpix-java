...
public final class DeleteSigningKey {

    private static final String OPERATION_ID = "delete_signing_key";
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSigningKeyRequest, DeleteSigningKeyResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteSigningKeyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSigningKeyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSigningKeyRequest request) {
        ...
        @Override
        public DeleteSigningKeyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteSigningKeyResponse.Builder resBuilder =
            ...
            DeleteSigningKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withDeleteSigningKeyResponse(Utils.unmarshal(response, new TypeReference<io.fastpix.sdk.models.components.DeleteSigningKeyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteSigningKeyRequest, io.fastpix.sdk.models.operations.async.DeleteSigningKeyResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSigningKeyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSigningKeyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSigningKeyRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.DeleteSigningKeyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.DeleteSigningKeyResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.DeleteSigningKeyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.DeleteSigningKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<io.fastpix.sdk.models.components.DeleteSigningKeyResponse>() {})
                            .thenApply(res::withDeleteSigningKeyResponse);
                } else {
