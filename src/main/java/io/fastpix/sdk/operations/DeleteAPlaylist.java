...
import io.fastpix.sdk.models.components.PlaylistDeleteResponse;
...
public final class DeleteAPlaylist {

    private static final String OPERATION_ID = "delete-a-playlist";
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteAPlaylistRequest, DeleteAPlaylistResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteAPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteAPlaylistRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteAPlaylistRequest request) {
        ...
        @Override
        public DeleteAPlaylistResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteAPlaylistResponse.Builder resBuilder =
            ...
            DeleteAPlaylistResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withPlaylistDeleteResponse(Utils.unmarshal(response, new TypeReference<PlaylistDeleteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteAPlaylistRequest, io.fastpix.sdk.models.operations.async.DeleteAPlaylistResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteAPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteAPlaylistRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteAPlaylistRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.DeleteAPlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.DeleteAPlaylistResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.DeleteAPlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.DeleteAPlaylistResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlaylistDeleteResponse>() {})
                            .thenApply(res::withPlaylistDeleteResponse);
                } else {
