...
import io.fastpix.sdk.models.operations.DeleteMediaTrackResponseBody;
...
public final class DeleteMediaTrack {

    private static final String OPERATION_ID = "delete-media-track";
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteMediaTrackRequest, DeleteMediaTrackResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteMediaTrackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMediaTrackRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteMediaTrackRequest request) {
        ...
        @Override
        public DeleteMediaTrackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteMediaTrackResponse.Builder resBuilder =
            ...
            DeleteMediaTrackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<DeleteMediaTrackResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteMediaTrackRequest, io.fastpix.sdk.models.operations.async.DeleteMediaTrackResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteMediaTrackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMediaTrackRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteMediaTrackRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.DeleteMediaTrackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.DeleteMediaTrackResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.DeleteMediaTrackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.DeleteMediaTrackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteMediaTrackResponseBody>() {})
