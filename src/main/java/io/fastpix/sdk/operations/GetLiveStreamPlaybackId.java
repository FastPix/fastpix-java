...
public final class GetLiveStreamPlaybackId {

    private static final String OPERATION_ID = "get-live-stream-playback-id";
    ...
    private GetLiveStreamPlaybackId() {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLiveStreamPlaybackIdRequest, GetLiveStreamPlaybackIdResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetLiveStreamPlaybackIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLiveStreamPlaybackIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLiveStreamPlaybackIdRequest request) {
        ...
        @Override
        public GetLiveStreamPlaybackIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLiveStreamPlaybackIdResponse.Builder resBuilder =
            ...
            GetLiveStreamPlaybackIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLiveStreamPlaybackIdRequest, io.fastpix.sdk.models.operations.async.GetLiveStreamPlaybackIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLiveStreamPlaybackIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLiveStreamPlaybackIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLiveStreamPlaybackIdRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetLiveStreamPlaybackIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetLiveStreamPlaybackIdResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetLiveStreamPlaybackIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetLiveStreamPlaybackIdResponse res = resBuilder.build();
