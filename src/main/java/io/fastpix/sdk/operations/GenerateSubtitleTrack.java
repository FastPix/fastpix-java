...
import io.fastpix.sdk.models.operations.GenerateSubtitleTrackResponseBody;
...
public final class GenerateSubtitleTrack {

    private static final String OPERATION_ID = "Generate-subtitle-track";
    ...
    public static class Sync extends Base
            implements RequestOperation<GenerateSubtitleTrackRequest, GenerateSubtitleTrackResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GenerateSubtitleTrackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GenerateSubtitleTrackRequest.class, new TypeReference<GenerateSubtitleTrackRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GenerateSubtitleTrackRequest request) {
        ...
        @Override
        public GenerateSubtitleTrackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GenerateSubtitleTrackResponse.Builder resBuilder =
            ...
            GenerateSubtitleTrackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GenerateSubtitleTrackResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GenerateSubtitleTrackRequest, io.fastpix.sdk.models.operations.async.GenerateSubtitleTrackResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GenerateSubtitleTrackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GenerateSubtitleTrackRequest.class, new TypeReference<GenerateSubtitleTrackRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GenerateSubtitleTrackRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GenerateSubtitleTrackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GenerateSubtitleTrackResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GenerateSubtitleTrackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GenerateSubtitleTrackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<GenerateSubtitleTrackResponseBody>() {})
