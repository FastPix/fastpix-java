...
import io.fastpix.sdk.models.operations.ListVideoViewsResponseBody;
...
public final class ListVideoViews {

    private static final String OPERATION_ID = "list_video_views";
    ...
    public static class Sync extends Base
            implements RequestOperation<ListVideoViewsRequest, ListVideoViewsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListVideoViewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVideoViewsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListVideoViewsRequest request) {
        ...
        @Override
        public ListVideoViewsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListVideoViewsResponse.Builder resBuilder =
            ...
            ListVideoViewsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListVideoViewsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListVideoViewsRequest, io.fastpix.sdk.models.operations.async.ListVideoViewsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListVideoViewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVideoViewsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListVideoViewsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListVideoViewsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListVideoViewsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListVideoViewsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ListVideoViewsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListVideoViewsResponseBody>() {})
