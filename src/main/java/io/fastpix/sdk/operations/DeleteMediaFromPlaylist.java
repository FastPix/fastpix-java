...
public final class DeleteMediaFromPlaylist {

    private static final String OPERATION_ID = "delete-media-from-playlist";
    ...
    private DeleteMediaFromPlaylist() {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteMediaFromPlaylistRequest, DeleteMediaFromPlaylistResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteMediaFromPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMediaFromPlaylistRequest.class, new TypeReference<DeleteMediaFromPlaylistRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteMediaFromPlaylistRequest request) {
        ...
        @Override
        public DeleteMediaFromPlaylistResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteMediaFromPlaylistResponse.Builder resBuilder =
            ...
            DeleteMediaFromPlaylistResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteMediaFromPlaylistRequest, io.fastpix.sdk.models.operations.async.DeleteMediaFromPlaylistResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteMediaFromPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMediaFromPlaylistRequest.class, new TypeReference<DeleteMediaFromPlaylistRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteMediaFromPlaylistRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.DeleteMediaFromPlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.DeleteMediaFromPlaylistResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.DeleteMediaFromPlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.DeleteMediaFromPlaylistResponse res = resBuilder.build();
