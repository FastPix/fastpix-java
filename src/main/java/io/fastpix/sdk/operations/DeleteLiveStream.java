...
public final class DeleteLiveStream {

    private static final String OPERATION_ID = "delete-live-stream";
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteLiveStreamRequest, DeleteLiveStreamResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteLiveStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteLiveStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteLiveStreamRequest request) {
        ...
        @Override
        public DeleteLiveStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteLiveStreamResponse.Builder resBuilder =
            ...
            DeleteLiveStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteLiveStreamRequest, io.fastpix.sdk.models.operations.async.DeleteLiveStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteLiveStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteLiveStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteLiveStreamRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.DeleteLiveStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.DeleteLiveStreamResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.DeleteLiveStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.DeleteLiveStreamResponse res = resBuilder.build();
