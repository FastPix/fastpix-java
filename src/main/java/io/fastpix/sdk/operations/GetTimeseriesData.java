...
import io.fastpix.sdk.models.operations.GetTimeseriesDataResponseBody;
...
public final class GetTimeseriesData {

    private static final String OPERATION_ID = "get_timeseries_data";
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTimeseriesDataRequest, GetTimeseriesDataResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetTimeseriesDataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTimeseriesDataRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTimeseriesDataRequest request) {
        ...
        @Override
        public GetTimeseriesDataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTimeseriesDataResponse.Builder resBuilder =
            ...
            GetTimeseriesDataResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetTimeseriesDataResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTimeseriesDataRequest, io.fastpix.sdk.models.operations.async.GetTimeseriesDataResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTimeseriesDataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTimeseriesDataRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTimeseriesDataRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetTimeseriesDataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetTimeseriesDataResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetTimeseriesDataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetTimeseriesDataResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetTimeseriesDataResponseBody>() {})
