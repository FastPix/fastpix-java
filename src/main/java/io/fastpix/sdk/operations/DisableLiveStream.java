...
public final class DisableLiveStream {

    private static final String OPERATION_ID = "disable-live-stream";
    ...
    public static class Sync extends Base
            implements RequestOperation<DisableLiveStreamRequest, DisableLiveStreamResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DisableLiveStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisableLiveStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DisableLiveStreamRequest request) {
        ...
        @Override
        public DisableLiveStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DisableLiveStreamResponse.Builder resBuilder =
            ...
            DisableLiveStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DisableLiveStreamRequest, io.fastpix.sdk.models.operations.async.DisableLiveStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DisableLiveStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisableLiveStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DisableLiveStreamRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.DisableLiveStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.DisableLiveStreamResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.DisableLiveStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.DisableLiveStreamResponse res = resBuilder.build();
