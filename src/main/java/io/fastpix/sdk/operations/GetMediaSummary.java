...
import io.fastpix.sdk.models.operations.GetMediaSummaryResponseBody;
...
public final class GetMediaSummary {

    private static final String OPERATION_ID = "get-media-summary";
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMediaSummaryRequest, GetMediaSummaryResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMediaSummaryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMediaSummaryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMediaSummaryRequest request) {
        ...
        @Override
        public GetMediaSummaryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMediaSummaryResponse.Builder resBuilder =
            ...
            GetMediaSummaryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetMediaSummaryResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMediaSummaryRequest, io.fastpix.sdk.models.operations.async.GetMediaSummaryResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMediaSummaryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMediaSummaryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMediaSummaryRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetMediaSummaryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetMediaSummaryResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetMediaSummaryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetMediaSummaryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetMediaSummaryResponseBody>() {})
