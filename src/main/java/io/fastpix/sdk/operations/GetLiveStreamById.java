...
public final class GetLiveStreamById {

    private static final String OPERATION_ID = "get-live-stream-by-id";
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLiveStreamByIdRequest, GetLiveStreamByIdResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetLiveStreamByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLiveStreamByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLiveStreamByIdRequest request) {
        ...
        @Override
        public GetLiveStreamByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetLiveStreamByIdResponse.Builder resBuilder =
            ...
            GetLiveStreamByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withLivestreamgetResponse(Utils.unmarshal(response, new TypeReference<LivestreamgetResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLiveStreamByIdRequest, io.fastpix.sdk.models.operations.async.GetLiveStreamByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLiveStreamByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLiveStreamByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLiveStreamByIdRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetLiveStreamByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetLiveStreamByIdResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetLiveStreamByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetLiveStreamByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<LivestreamgetResponse>() {})
                            .thenApply(res::withLivestreamgetResponse);
                } else {
