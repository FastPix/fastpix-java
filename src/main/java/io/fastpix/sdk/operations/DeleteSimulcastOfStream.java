...
public final class DeleteSimulcastOfStream {

    private static final String OPERATION_ID = "delete-simulcast-of-stream";
    ...
    private DeleteSimulcastOfStream() {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSimulcastOfStreamRequest, DeleteSimulcastOfStreamResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteSimulcastOfStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSimulcastOfStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSimulcastOfStreamRequest request) {
        ...
        @Override
        public DeleteSimulcastOfStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteSimulcastOfStreamResponse.Builder resBuilder =
            ...
            DeleteSimulcastOfStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withSimulcastdeleteResponse(Utils.unmarshal(response, new TypeReference<SimulcastdeleteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteSimulcastOfStreamRequest, io.fastpix.sdk.models.operations.async.DeleteSimulcastOfStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSimulcastOfStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSimulcastOfStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSimulcastOfStreamRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.DeleteSimulcastOfStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.DeleteSimulcastOfStreamResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.DeleteSimulcastOfStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.DeleteSimulcastOfStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<SimulcastdeleteResponse>() {})
                            .thenApply(res::withSimulcastdeleteResponse);
                } else {
