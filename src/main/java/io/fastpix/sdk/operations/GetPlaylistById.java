...
public final class GetPlaylistById {

    private static final String OPERATION_ID = "get-playlist-by-id";
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPlaylistByIdRequest, GetPlaylistByIdResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetPlaylistByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaylistByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPlaylistByIdRequest request) {
        ...
        @Override
        public GetPlaylistByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPlaylistByIdResponse.Builder resBuilder =
            ...
            GetPlaylistByIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPlaylistByIdRequest, io.fastpix.sdk.models.operations.async.GetPlaylistByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPlaylistByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPlaylistByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPlaylistByIdRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetPlaylistByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetPlaylistByIdResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetPlaylistByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetPlaylistByIdResponse res = resBuilder.build();
