...
import io.fastpix.sdk.models.operations.UpdateMediaNamedEntitiesResponseBody;
...
public final class UpdateMediaNamedEntities {

    private static final String OPERATION_ID = "update-media-named-entities";
    ...
    private UpdateMediaNamedEntities() {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMediaNamedEntitiesRequest, UpdateMediaNamedEntitiesResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateMediaNamedEntitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMediaNamedEntitiesRequest.class, new TypeReference<UpdateMediaNamedEntitiesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMediaNamedEntitiesRequest request) {
        ...
        @Override
        public UpdateMediaNamedEntitiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMediaNamedEntitiesResponse.Builder resBuilder =
            ...
            UpdateMediaNamedEntitiesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdateMediaNamedEntitiesResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMediaNamedEntitiesRequest, io.fastpix.sdk.models.operations.async.UpdateMediaNamedEntitiesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMediaNamedEntitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMediaNamedEntitiesRequest.class, new TypeReference<UpdateMediaNamedEntitiesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMediaNamedEntitiesRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdateMediaNamedEntitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdateMediaNamedEntitiesResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdateMediaNamedEntitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdateMediaNamedEntitiesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateMediaNamedEntitiesResponseBody>() {})
