...
import io.fastpix.sdk.models.operations.UpdatedSourceAccessResponseBody;
...
public final class UpdatedSourceAccess {

    private static final String OPERATION_ID = "updated-source-access";
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdatedSourceAccessRequest, UpdatedSourceAccessResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdatedSourceAccessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatedSourceAccessRequest.class, new TypeReference<UpdatedSourceAccessRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatedSourceAccessRequest request) {
        ...
        @Override
        public UpdatedSourceAccessResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdatedSourceAccessResponse.Builder resBuilder =
            ...
            UpdatedSourceAccessResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdatedSourceAccessResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdatedSourceAccessRequest, io.fastpix.sdk.models.operations.async.UpdatedSourceAccessResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdatedSourceAccessRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdatedSourceAccessRequest.class, new TypeReference<UpdatedSourceAccessRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatedSourceAccessRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdatedSourceAccessResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdatedSourceAccessResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdatedSourceAccessResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdatedSourceAccessResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdatedSourceAccessResponseBody>() {})
