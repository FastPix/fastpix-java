...
public final class GetAllStreams {

    private static final String OPERATION_ID = "get-all-streams";
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllStreamsRequest, GetAllStreamsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAllStreamsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllStreamsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllStreamsRequest request) {
        ...
        @Override
        public GetAllStreamsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllStreamsResponse.Builder resBuilder =
            ...
            GetAllStreamsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withGetStreamsResponse(Utils.unmarshal(response, new TypeReference<GetStreamsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllStreamsRequest, io.fastpix.sdk.models.operations.async.GetAllStreamsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAllStreamsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllStreamsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllStreamsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetAllStreamsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetAllStreamsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetAllStreamsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetAllStreamsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetStreamsResponse>() {})
                            .thenApply(res::withGetStreamsResponse);
                } else {
