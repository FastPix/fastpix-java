...
public final class UpdateSpecificSimulcastOfStream {

    private static final String OPERATION_ID = "update-specific-simulcast-of-stream";
    ...
    private UpdateSpecificSimulcastOfStream() {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSpecificSimulcastOfStreamRequest, UpdateSpecificSimulcastOfStreamResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateSpecificSimulcastOfStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSpecificSimulcastOfStreamRequest.class, new TypeReference<UpdateSpecificSimulcastOfStreamRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSpecificSimulcastOfStreamRequest request) {
        ...
        @Override
        public UpdateSpecificSimulcastOfStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSpecificSimulcastOfStreamResponse.Builder resBuilder =
            ...
            UpdateSpecificSimulcastOfStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withSimulcastUpdateResponse(Utils.unmarshal(response, new TypeReference<SimulcastUpdateResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateSpecificSimulcastOfStreamRequest, io.fastpix.sdk.models.operations.async.UpdateSpecificSimulcastOfStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSpecificSimulcastOfStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSpecificSimulcastOfStreamRequest.class, new TypeReference<UpdateSpecificSimulcastOfStreamRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSpecificSimulcastOfStreamRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdateSpecificSimulcastOfStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdateSpecificSimulcastOfStreamResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdateSpecificSimulcastOfStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdateSpecificSimulcastOfStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<SimulcastUpdateResponse>() {})
                            .thenApply(res::withSimulcastUpdateResponse);
                } else {
