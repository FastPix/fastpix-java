...
public final class DeleteMediaPlaybackId {

    private static final String OPERATION_ID = "delete-media-playback-id";
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteMediaPlaybackIdRequest, DeleteMediaPlaybackIdResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteMediaPlaybackIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMediaPlaybackIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteMediaPlaybackIdRequest request) {
        ...
        @Override
        public DeleteMediaPlaybackIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteMediaPlaybackIdResponse.Builder resBuilder =
            ...
            DeleteMediaPlaybackIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<DeleteMediaPlaybackIdResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteMediaPlaybackIdRequest, io.fastpix.sdk.models.operations.async.DeleteMediaPlaybackIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteMediaPlaybackIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMediaPlaybackIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteMediaPlaybackIdRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.DeleteMediaPlaybackIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.DeleteMediaPlaybackIdResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.DeleteMediaPlaybackIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.DeleteMediaPlaybackIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteMediaPlaybackIdResponseBody>() {})
