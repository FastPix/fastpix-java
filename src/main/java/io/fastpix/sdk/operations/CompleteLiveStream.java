...
public final class CompleteLiveStream {

    private static final String OPERATION_ID = "complete-live-stream";
    ...
    public static class Sync extends Base
            implements RequestOperation<CompleteLiveStreamRequest, CompleteLiveStreamResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CompleteLiveStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CompleteLiveStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CompleteLiveStreamRequest request) {
        ...
        @Override
        public CompleteLiveStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CompleteLiveStreamResponse.Builder resBuilder =
            ...
            CompleteLiveStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CompleteLiveStreamRequest, io.fastpix.sdk.models.operations.async.CompleteLiveStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CompleteLiveStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CompleteLiveStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CompleteLiveStreamRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.CompleteLiveStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.CompleteLiveStreamResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.CompleteLiveStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.CompleteLiveStreamResponse res = resBuilder.build();
