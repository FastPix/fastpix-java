...
public final class EnableLiveStream {

    private static final String OPERATION_ID = "enable-live-stream";
    ...
    public static class Sync extends Base
            implements RequestOperation<EnableLiveStreamRequest, EnableLiveStreamResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EnableLiveStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EnableLiveStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EnableLiveStreamRequest request) {
        ...
        @Override
        public EnableLiveStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EnableLiveStreamResponse.Builder resBuilder =
            ...
            EnableLiveStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EnableLiveStreamRequest, io.fastpix.sdk.models.operations.async.EnableLiveStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EnableLiveStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EnableLiveStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EnableLiveStreamRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.EnableLiveStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.EnableLiveStreamResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.EnableLiveStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.EnableLiveStreamResponse res = resBuilder.build();
