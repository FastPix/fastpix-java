...
import io.fastpix.sdk.models.operations.ListLiveClipsResponseBody;
...
public final class ListLiveClips {

    private static final String OPERATION_ID = "list-live-clips";
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLiveClipsRequest, ListLiveClipsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListLiveClipsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLiveClipsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLiveClipsRequest request) {
        ...
        @Override
        public ListLiveClipsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListLiveClipsResponse.Builder resBuilder =
            ...
            ListLiveClipsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListLiveClipsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLiveClipsRequest, io.fastpix.sdk.models.operations.async.ListLiveClipsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListLiveClipsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLiveClipsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLiveClipsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListLiveClipsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListLiveClipsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListLiveClipsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ListLiveClipsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListLiveClipsResponseBody>() {})
