...
import io.fastpix.sdk.models.operations.ListOverallValuesResponseBody;
...
public final class ListOverallValues {

    private static final String OPERATION_ID = "list_overall_values";
    ...
    public static class Sync extends Base
            implements RequestOperation<ListOverallValuesRequest, ListOverallValuesResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListOverallValuesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListOverallValuesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListOverallValuesRequest request) {
        ...
        @Override
        public ListOverallValuesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListOverallValuesResponse.Builder resBuilder =
            ...
            ListOverallValuesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListOverallValuesResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListOverallValuesRequest, io.fastpix.sdk.models.operations.async.ListOverallValuesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListOverallValuesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListOverallValuesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListOverallValuesRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListOverallValuesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListOverallValuesResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListOverallValuesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ListOverallValuesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListOverallValuesResponseBody>() {})
