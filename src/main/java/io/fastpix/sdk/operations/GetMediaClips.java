...
import io.fastpix.sdk.models.components.MediaClipResponse;
...
public final class GetMediaClips {

    private static final String OPERATION_ID = "get-media-clips";
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMediaClipsRequest, GetMediaClipsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetMediaClipsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMediaClipsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMediaClipsRequest request) {
        ...
        @Override
        public GetMediaClipsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetMediaClipsResponse.Builder resBuilder =
            ...
            GetMediaClipsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withMediaClipResponse(Utils.unmarshal(response, new TypeReference<MediaClipResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMediaClipsRequest, io.fastpix.sdk.models.operations.async.GetMediaClipsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMediaClipsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMediaClipsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMediaClipsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetMediaClipsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetMediaClipsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetMediaClipsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetMediaClipsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<MediaClipResponse>() {})
                            .thenApply(res::withMediaClipResponse);
                } else {
