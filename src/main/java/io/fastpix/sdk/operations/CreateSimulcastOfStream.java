...
public final class CreateSimulcastOfStream {

    private static final String OPERATION_ID = "create-simulcast-of-stream";
    ...
    private CreateSimulcastOfStream() {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSimulcastOfStreamRequest, CreateSimulcastOfStreamResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateSimulcastOfStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSimulcastOfStreamRequest.class, new TypeReference<CreateSimulcastOfStreamRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSimulcastOfStreamRequest request) {
        ...
        @Override
        public CreateSimulcastOfStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSimulcastOfStreamResponse.Builder resBuilder =
            ...
            CreateSimulcastOfStreamResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateSimulcastOfStreamRequest, io.fastpix.sdk.models.operations.async.CreateSimulcastOfStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateSimulcastOfStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSimulcastOfStreamRequest.class, new TypeReference<CreateSimulcastOfStreamRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateSimulcastOfStreamRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.CreateSimulcastOfStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.CreateSimulcastOfStreamResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.CreateSimulcastOfStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.CreateSimulcastOfStreamResponse res = resBuilder.build();
