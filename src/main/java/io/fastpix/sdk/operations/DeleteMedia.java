...
public final class DeleteMedia {

    private static final String OPERATION_ID = "delete-media";
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteMediaRequest, DeleteMediaResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMediaRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteMediaRequest request) {
        ...
        @Override
        public DeleteMediaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteMediaResponse.Builder resBuilder =
                    DeleteMediaResponse
                            .builder()
            ...
            DeleteMediaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<DeleteMediaResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteMediaRequest, io.fastpix.sdk.models.operations.async.DeleteMediaResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteMediaRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteMediaRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.DeleteMediaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.DeleteMediaResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.DeleteMediaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.DeleteMediaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<DeleteMediaResponseBody>() {})
