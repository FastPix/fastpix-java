...
import io.fastpix.sdk.models.components.PlaylistByIdResponse;
...
public final class ChangeMediaOrderInPlaylist {

    private static final String OPERATION_ID = "change-media-order-in-playlist";
    ...
    private ChangeMediaOrderInPlaylist() {
    ...
    public static class Sync extends Base
            implements RequestOperation<ChangeMediaOrderInPlaylistRequest, ChangeMediaOrderInPlaylistResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ChangeMediaOrderInPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ChangeMediaOrderInPlaylistRequest.class, new TypeReference<ChangeMediaOrderInPlaylistRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ChangeMediaOrderInPlaylistRequest request) {
        ...
        @Override
        public ChangeMediaOrderInPlaylistResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ChangeMediaOrderInPlaylistResponse.Builder resBuilder =
            ...
            ChangeMediaOrderInPlaylistResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withPlaylistByIdResponse(Utils.unmarshal(response, new TypeReference<PlaylistByIdResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ChangeMediaOrderInPlaylistRequest, io.fastpix.sdk.models.operations.async.ChangeMediaOrderInPlaylistResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ChangeMediaOrderInPlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ChangeMediaOrderInPlaylistRequest.class, new TypeReference<ChangeMediaOrderInPlaylistRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ChangeMediaOrderInPlaylistRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ChangeMediaOrderInPlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ChangeMediaOrderInPlaylistResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ChangeMediaOrderInPlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ChangeMediaOrderInPlaylistResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlaylistByIdResponse>() {})
                            .thenApply(res::withPlaylistByIdResponse);
                } else {
