...
public final class GetAllPlaylists {

    private static final String OPERATION_ID = "get-all-playlists";
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllPlaylistsRequest, GetAllPlaylistsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetAllPlaylistsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllPlaylistsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllPlaylistsRequest request) {
        ...
        @Override
        public GetAllPlaylistsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetAllPlaylistsResponse.Builder resBuilder =
            ...
            GetAllPlaylistsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withGetAllPlaylistsResponse(Utils.unmarshal(response, new TypeReference<io.fastpix.sdk.models.components.GetAllPlaylistsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllPlaylistsRequest, io.fastpix.sdk.models.operations.async.GetAllPlaylistsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAllPlaylistsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllPlaylistsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllPlaylistsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetAllPlaylistsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetAllPlaylistsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetAllPlaylistsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetAllPlaylistsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<io.fastpix.sdk.models.components.GetAllPlaylistsResponse>() {})
                            .thenApply(res::withGetAllPlaylistsResponse);
                } else {
