...
import io.fastpix.sdk.models.operations.AddMediaTrackResponseBody;
...
public class AddMediaTrack {

    private static final String OPERATION_ID = "Add-media-track";
    ...
    public static class Sync extends Base
            implements RequestOperation<AddMediaTrackRequest, AddMediaTrackResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AddMediaTrackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddMediaTrackRequest.class, new TypeReference<AddMediaTrackRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddMediaTrackRequest request) {
        ...
        @Override
        public AddMediaTrackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddMediaTrackResponse.Builder resBuilder =
            ...
            AddMediaTrackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<AddMediaTrackResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddMediaTrackRequest, io.fastpix.sdk.models.operations.async.AddMediaTrackResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddMediaTrackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddMediaTrackRequest.class, new TypeReference<AddMediaTrackRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddMediaTrackRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.AddMediaTrackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.AddMediaTrackResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.AddMediaTrackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.AddMediaTrackResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<AddMediaTrackResponseBody>() {})
