...
import io.fastpix.sdk.models.operations.UpdateUserAgentRestrictionsResponseBody;
...
public final class UpdateUserAgentRestrictions {

    private static final String OPERATION_ID = "update-user-agent-restrictions";
    ...
    private UpdateUserAgentRestrictions() {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateUserAgentRestrictionsRequest, UpdateUserAgentRestrictionsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateUserAgentRestrictionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUserAgentRestrictionsRequest.class, new TypeReference<UpdateUserAgentRestrictionsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateUserAgentRestrictionsRequest request) {
        ...
        @Override
        public UpdateUserAgentRestrictionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateUserAgentRestrictionsResponse.Builder resBuilder =
            ...
            UpdateUserAgentRestrictionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdateUserAgentRestrictionsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateUserAgentRestrictionsRequest, io.fastpix.sdk.models.operations.async.UpdateUserAgentRestrictionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateUserAgentRestrictionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateUserAgentRestrictionsRequest.class, new TypeReference<UpdateUserAgentRestrictionsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateUserAgentRestrictionsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdateUserAgentRestrictionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdateUserAgentRestrictionsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdateUserAgentRestrictionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdateUserAgentRestrictionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateUserAgentRestrictionsResponseBody>() {})
