...
import io.fastpix.sdk.models.operations.GetVideoViewDetailsResponseBody;
...
public final class GetVideoViewDetails {

    private static final String OPERATION_ID = "get_video_view_details";
    ...
    public static class Sync extends Base
            implements RequestOperation<GetVideoViewDetailsRequest, GetVideoViewDetailsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetVideoViewDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetVideoViewDetailsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetVideoViewDetailsRequest request) {
        ...
        @Override
        public GetVideoViewDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetVideoViewDetailsResponse.Builder resBuilder =
            ...
            GetVideoViewDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetVideoViewDetailsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetVideoViewDetailsRequest, io.fastpix.sdk.models.operations.async.GetVideoViewDetailsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetVideoViewDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetVideoViewDetailsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetVideoViewDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetVideoViewDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetVideoViewDetailsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetVideoViewDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetVideoViewDetailsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetVideoViewDetailsResponseBody>() {})
