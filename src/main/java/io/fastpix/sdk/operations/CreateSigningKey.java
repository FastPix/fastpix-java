...
import io.fastpix.sdk.models.components.CreateResponse;
...
public final class CreateSigningKey {

    private static final String OPERATION_ID = "create_signing_key";
    ...
    public static class Sync extends Base
            implements RequestlessOperation<CreateSigningKeyResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        @Override
        public CreateSigningKeyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateSigningKeyResponse.Builder resBuilder =
            ...
            CreateSigningKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withCreateResponse(Utils.unmarshal(response, new TypeReference<CreateResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<io.fastpix.sdk.models.operations.async.CreateSigningKeyResponse> {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.CreateSigningKeyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.CreateSigningKeyResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.CreateSigningKeyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.CreateSigningKeyResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateResponse>() {})
                            .thenApply(res::withCreateResponse);
                } else {
