...
import io.fastpix.sdk.models.operations.UpdateDomainRestrictionsResponseBody;
...
public final class UpdateDomainRestrictions {

    private static final String OPERATION_ID = "update-domain-restrictions";
    ...
    private UpdateDomainRestrictions() {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateDomainRestrictionsRequest, UpdateDomainRestrictionsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateDomainRestrictionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDomainRestrictionsRequest.class, new TypeReference<UpdateDomainRestrictionsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateDomainRestrictionsRequest request) {
        ...
        @Override
        public UpdateDomainRestrictionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateDomainRestrictionsResponse.Builder resBuilder =
            ...
            UpdateDomainRestrictionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdateDomainRestrictionsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateDomainRestrictionsRequest, io.fastpix.sdk.models.operations.async.UpdateDomainRestrictionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateDomainRestrictionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateDomainRestrictionsRequest.class, new TypeReference<UpdateDomainRestrictionsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateDomainRestrictionsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdateDomainRestrictionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdateDomainRestrictionsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdateDomainRestrictionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdateDomainRestrictionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateDomainRestrictionsResponseBody>() {})
