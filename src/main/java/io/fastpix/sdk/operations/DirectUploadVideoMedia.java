...
public final class DirectUploadVideoMedia {
    ...
    public static class Sync extends Base
            implements RequestOperation<DirectUploadVideoMediaRequest, DirectUploadVideoMediaResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DirectUploadVideoMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<DirectUploadVideoMediaRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DirectUploadVideoMediaRequest request) {
        ...
        @Override
        public DirectUploadVideoMediaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DirectUploadVideoMediaResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DirectUploadVideoMediaRequest, io.fastpix.sdk.models.operations.async.DirectUploadVideoMediaResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DirectUploadVideoMediaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<DirectUploadVideoMediaRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DirectUploadVideoMediaRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.DirectUploadVideoMediaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.DirectUploadVideoMediaResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.DirectUploadVideoMediaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
