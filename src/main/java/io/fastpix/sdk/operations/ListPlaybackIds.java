...
import io.fastpix.sdk.models.operations.ListPlaybackIdsResponseBody;
...
public final class ListPlaybackIds {

    private static final String OPERATION_ID = "list-playback-ids";
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPlaybackIdsRequest, ListPlaybackIdsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ListPlaybackIdsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPlaybackIdsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPlaybackIdsRequest request) {
        ...
        @Override
        public ListPlaybackIdsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListPlaybackIdsResponse.Builder resBuilder =
            ...
            ListPlaybackIdsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<ListPlaybackIdsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPlaybackIdsRequest, io.fastpix.sdk.models.operations.async.ListPlaybackIdsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListPlaybackIdsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPlaybackIdsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPlaybackIdsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.ListPlaybackIdsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.ListPlaybackIdsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.ListPlaybackIdsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.ListPlaybackIdsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListPlaybackIdsResponseBody>() {})
