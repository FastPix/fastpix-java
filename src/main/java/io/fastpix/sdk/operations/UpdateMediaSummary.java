...
import io.fastpix.sdk.models.operations.UpdateMediaSummaryResponse;
import io.fastpix.sdk.models.operations.UpdateMediaSummaryResponseBody;
...
public final class UpdateMediaSummary {

    private static final String OPERATION_ID = "update-media-summary";
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMediaSummaryRequest, UpdateMediaSummaryResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateMediaSummaryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMediaSummaryRequest.class, new TypeReference<UpdateMediaSummaryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMediaSummaryRequest request) {
        ...
        @Override
        public UpdateMediaSummaryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMediaSummaryResponse.Builder resBuilder =
            ...
            UpdateMediaSummaryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdateMediaSummaryResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMediaSummaryRequest, io.fastpix.sdk.models.operations.async.UpdateMediaSummaryResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMediaSummaryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMediaSummaryRequest.class, new TypeReference<UpdateMediaSummaryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMediaSummaryRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdateMediaSummaryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdateMediaSummaryResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdateMediaSummaryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdateMediaSummaryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateMediaSummaryResponseBody>() {})
