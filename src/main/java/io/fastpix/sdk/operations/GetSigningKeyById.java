...
import io.fastpix.sdk.models.components.GetPublicPemUsingSigningKeyIdResponseDTO;
import io.fastpix.sdk.models.errors.APIException;
import io.fastpix.sdk.models.operations.GetSigningKeyByIdRequest;
import io.fastpix.sdk.models.operations.GetSigningKeyByIdResponse;
...
public final class GetSigningKeyById {

    private static final String OPERATION_ID = "get-signing_key_by_id";
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSigningKeyByIdRequest, GetSigningKeyByIdResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(GetSigningKeyByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSigningKeyByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSigningKeyByIdRequest request) {
        ...
        @Override
        public GetSigningKeyByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetSigningKeyByIdResponse.Builder resBuilder =
            ...
            GetSigningKeyByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withGetPublicPemUsingSigningKeyIdResponseDTO(Utils.unmarshal(response, new TypeReference<GetPublicPemUsingSigningKeyIdResponseDTO>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSigningKeyByIdRequest, io.fastpix.sdk.models.operations.async.GetSigningKeyByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSigningKeyByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSigningKeyByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSigningKeyByIdRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.GetSigningKeyByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.GetSigningKeyByIdResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.GetSigningKeyByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.GetSigningKeyByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetPublicPemUsingSigningKeyIdResponseDTO>() {})
                            .thenApply(res::withGetPublicPemUsingSigningKeyIdResponseDTO);
                } else {
