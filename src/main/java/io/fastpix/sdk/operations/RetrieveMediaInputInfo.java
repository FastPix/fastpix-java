...
public final class RetrieveMediaInputInfo {

    private static final String OPERATION_ID = "retrieveMediaInputInfo";
    ...
    private RetrieveMediaInputInfo() {
    ...
    public static class Sync extends Base
            implements RequestOperation<RetrieveMediaInputInfoRequest, RetrieveMediaInputInfoResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(RetrieveMediaInputInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RetrieveMediaInputInfoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RetrieveMediaInputInfoRequest request) {
        ...
        @Override
        public RetrieveMediaInputInfoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RetrieveMediaInputInfoResponse.Builder resBuilder =
            ...
            RetrieveMediaInputInfoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<RetrieveMediaInputInfoResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RetrieveMediaInputInfoRequest, io.fastpix.sdk.models.operations.async.RetrieveMediaInputInfoResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RetrieveMediaInputInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RetrieveMediaInputInfoRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RetrieveMediaInputInfoRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.RetrieveMediaInputInfoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.RetrieveMediaInputInfoResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.RetrieveMediaInputInfoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.RetrieveMediaInputInfoResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<RetrieveMediaInputInfoResponseBody>() {})
