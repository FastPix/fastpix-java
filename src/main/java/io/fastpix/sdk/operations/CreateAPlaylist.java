...
/**
 * Holder for the generated Sync/Async operation classes. The leading-underscore headers
 * field/parameter, the securitySource field/accessor sharing a name, and the existing
 * interrupt handling are intentional generated conventions kept verbatim; the suppressions
 * avoid changing the generated runtime behavior.
 */
@SuppressWarnings({"java:S116", "java:S117", "java:S1845", "java:S2142"})
public final class CreateAPlaylist {

    private static final String OPERATION_ID = "create-a-playlist";
    ...
    public static class Sync extends Base
            implements RequestOperation<CreatePlaylistRequest, CreateAPlaylistResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreatePlaylistRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CreatePlaylistRequest>() {});
        ...
        @Override
        public CreateAPlaylistResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAPlaylistResponse.Builder resBuilder =
            ...
            CreateAPlaylistResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreatePlaylistRequest, io.fastpix.sdk.models.operations.async.CreateAPlaylistResponse> {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.CreateAPlaylistResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.CreateAPlaylistResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.CreateAPlaylistResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.CreateAPlaylistResponse res = resBuilder.build();
