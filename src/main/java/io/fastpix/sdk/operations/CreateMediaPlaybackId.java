...
public class CreateMediaPlaybackId {

    private static final String OPERATION_ID = "create-media-playback-id";
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMediaPlaybackIdRequest, CreateMediaPlaybackIdResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(CreateMediaPlaybackIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMediaPlaybackIdRequest.class, new TypeReference<CreateMediaPlaybackIdRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMediaPlaybackIdRequest request) {
        ...
        @Override
        public CreateMediaPlaybackIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateMediaPlaybackIdResponse.Builder resBuilder =
            ...
            CreateMediaPlaybackIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<CreateMediaPlaybackIdResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateMediaPlaybackIdRequest, io.fastpix.sdk.models.operations.async.CreateMediaPlaybackIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateMediaPlaybackIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateMediaPlaybackIdRequest.class, new TypeReference<CreateMediaPlaybackIdRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMediaPlaybackIdRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.CreateMediaPlaybackIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.CreateMediaPlaybackIdResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.CreateMediaPlaybackIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.CreateMediaPlaybackIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateMediaPlaybackIdResponseBody>() {})
