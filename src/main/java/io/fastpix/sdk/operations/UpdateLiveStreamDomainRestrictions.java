...
public final class UpdateLiveStreamDomainRestrictions {

    private static final String OPERATION_ID = "update-live-stream-domain-restrictions";
    ...
    private UpdateLiveStreamDomainRestrictions() {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateLiveStreamDomainRestrictionsRequest, UpdateLiveStreamDomainRestrictionsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateLiveStreamDomainRestrictionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLiveStreamDomainRestrictionsRequest.class, new TypeReference<UpdateLiveStreamDomainRestrictionsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateLiveStreamDomainRestrictionsRequest request) {
        ...
        @Override
        public UpdateLiveStreamDomainRestrictionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateLiveStreamDomainRestrictionsResponse.Builder resBuilder =
            ...
            UpdateLiveStreamDomainRestrictionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdateLiveStreamDomainRestrictionsResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateLiveStreamDomainRestrictionsRequest, io.fastpix.sdk.models.operations.async.UpdateLiveStreamDomainRestrictionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateLiveStreamDomainRestrictionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateLiveStreamDomainRestrictionsRequest.class, new TypeReference<UpdateLiveStreamDomainRestrictionsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateLiveStreamDomainRestrictionsRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.UpdateLiveStreamDomainRestrictionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.UpdateLiveStreamDomainRestrictionsResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.UpdateLiveStreamDomainRestrictionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.UpdateLiveStreamDomainRestrictionsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateLiveStreamDomainRestrictionsResponseBody>() {})
