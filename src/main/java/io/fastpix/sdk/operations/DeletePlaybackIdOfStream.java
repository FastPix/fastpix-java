...
public final class DeletePlaybackIdOfStream {

    private static final String OPERATION_ID = "delete-playbackId-of-stream";
    ...
    private DeletePlaybackIdOfStream() {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePlaybackIdOfStreamRequest, DeletePlaybackIdOfStreamResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeletePlaybackIdOfStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePlaybackIdOfStreamRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePlaybackIdOfStreamRequest request) {
        ...
        @Override
        public DeletePlaybackIdOfStreamResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePlaybackIdOfStreamResponse.Builder resBuilder =
            ...
            DeletePlaybackIdOfStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return res.withLiveStreamDeleteResponse(Utils.unmarshal(response, new TypeReference<LiveStreamDeleteResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletePlaybackIdOfStreamRequest, io.fastpix.sdk.models.operations.async.DeletePlaybackIdOfStreamResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeletePlaybackIdOfStreamRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePlaybackIdOfStreamRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletePlaybackIdOfStreamRequest request) {
        ...
        @Override
        public CompletableFuture<io.fastpix.sdk.models.operations.async.DeletePlaybackIdOfStreamResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            io.fastpix.sdk.models.operations.async.DeletePlaybackIdOfStreamResponse.Builder resBuilder =
                    io.fastpix.sdk.models.operations.async.DeletePlaybackIdOfStreamResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            io.fastpix.sdk.models.operations.async.DeletePlaybackIdOfStreamResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, APPLICATION_JSON)) {
                    return Utils.unmarshalAsync(response, new TypeReference<LiveStreamDeleteResponse>() {})
                            .thenApply(res::withLiveStreamDeleteResponse);
                } else {
