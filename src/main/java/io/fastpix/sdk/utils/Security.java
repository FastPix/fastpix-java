...
public final class Security {
    ...
    public static Optional<Object> findComplexObjectWithNonEmptyAnnotatedField(Object object, String... regexes) {
        ...
        while (!stack.isEmpty()) {
            ...
            List<Field> annotatedFields = Arrays.stream(fields) //
                    .filter(f -> {
                        FastpixMetadata[] anns = f.getDeclaredAnnotationsByType(FastpixMetadata.class);
    ...
    private static boolean matches(FastpixMetadata[] anns, String regex) {
        Pattern pattern = Pattern.compile(regex);
        for (FastpixMetadata ann : anns) {
