...
public class Streams {
     ...
     */
    public CreateNewStreamResponse create(@Nonnull CreateLiveStreamRequest request) {
     ...
     * @throws RuntimeException subclass if the API call fails
     */
    public CreateNewStreamResponse create(@Nonnull CreateLiveStreamRequest request, @Nullable Options options) {
     ...
     * @throws RuntimeException subclass if the API call fails
     */
    public GetAllStreamsResponse listDirect() {
     ...
     * @throws RuntimeException subclass if the API call fails
     */
    public GetAllStreamsResponse list(
