package io.fastpix.sdk.hooks;

//
// This file is written once by fastpix code generation and
// thereafter will not be overwritten by fastpix updates. As a
...
public final class SDKHooks {
    ...
    public static void initialize(io.fastpix.sdk.utils.AsyncHooks asyncHooks) {
        ...
        // asyncHooks.registerAfterError(io.fastpix.sdk.utils.HookAdapters.adapt(mySyncHook));
