...
public class PatchResponseData {
    ...
    private Optional<? extends PatchResponseDataMetadata> metadata;
    ...
    private Optional<? extends PatchResponseDataSrtPlaybackResponse> srtPlaybackResponse;
    ...
    public PatchResponseData(
            ...
            @JsonProperty("metadata") Optional<? extends PatchResponseDataMetadata> metadata,
            @JsonProperty("playbackId") Optional<? extends List<PlaybackIds>> playbackId,
            @JsonProperty("srtPlaybackResponse") Optional<? extends PatchResponseDataSrtPlaybackResponse> srtPlaybackResponse) {
    ...
    @JsonIgnore
    public Optional<PatchResponseDataMetadata> metadata() {
        return (Optional<PatchResponseDataMetadata>) metadata;
    }
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<PatchResponseDataSrtPlaybackResponse> srtPlaybackResponse() {
        return (Optional<PatchResponseDataSrtPlaybackResponse>) srtPlaybackResponse;
    }
     ...
     * Upon creating a new live stream, FastPix assigns a unique identifier to the stream.
     */
    public PatchResponseData withStreamId(String streamId) {
        Utils.checkNotNull(streamId, "streamId");
     ...
     * Upon creating a new live stream, FastPix assigns a unique identifier to the stream.
     */
    public PatchResponseData withStreamId(Optional<String> streamId) {
        Utils.checkNotNull(streamId, "streamId");
        this.streamId = streamId;
        return this;
    }
     ...
     * A unique stream key is generated for streaming, allowing the user to start streaming on any third-party platform using this key.
     */
    public PatchResponseData withStreamKey(String streamKey) {
        Utils.checkNotNull(streamKey, "streamKey");
     ...
     * A unique stream key is generated for streaming, allowing the user to start streaming on any third-party platform using this key.
     */
    public PatchResponseData withStreamKey(Optional<String> streamKey) {
        Utils.checkNotNull(streamKey, "streamKey");
        this.streamKey = streamKey;
        return this;
    }
     ...
     * A secret used for securing the SRT stream. This ensures that only authorized users can access the stream.
     */
    public PatchResponseData withSrtSecret(String srtSecret) {
        Utils.checkNotNull(srtSecret, "srtSecret");
     ...
     * A secret used for securing the SRT stream. This ensures that only authorized users can access the stream.
     */
    public PatchResponseData withSrtSecret(Optional<String> srtSecret) {
        Utils.checkNotNull(srtSecret, "srtSecret");
        this.srtSecret = srtSecret;
        return this;
    }
     ...
     * FastPix allows for a to trial the live stream for free. The duration of trial streams is five minutes. After five minutes of activity, the trial stream is turned off, and the recorded asset is removed after a day.
     */
    public PatchResponseData withTrial(Optional<Boolean> trial) {
        Utils.checkNotNull(trial, "trial");
        this.trial = trial;
        return this;
    }
     ...
     * The current live stream status can be one of four values:Idle, Preparing, Active or Disabled.The Idle status signifies that there isn't a broadcast in progress.The preparing status indicates that the stream is getting prepared. while, the Active status indicates that a broadcast is currently in progress. The Disabled status means that no more RTMP streams can be published.
     */
    public PatchResponseData withStatus(String status) {
        Utils.checkNotNull(status, "status");
     ...
     * The current live stream status can be one of four values:Idle, Preparing, Active or Disabled.The Idle status signifies that there isn't a broadcast in progress.The preparing status indicates that the stream is getting prepared. while, the Active status indicates that a broadcast is currently in progress. The Disabled status means that no more RTMP streams can be published.
     */
    public PatchResponseData withStatus(Optional<String> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Max resolution can be used to control the maximum resolution your media is encoded, stored, and streamed at.
     */
    public PatchResponseData withMaxResolution(String maxResolution) {
        Utils.checkNotNull(maxResolution, "maxResolution");
     ...
     * Max resolution can be used to control the maximum resolution your media is encoded, stored, and streamed at.
     */
    public PatchResponseData withMaxResolution(Optional<String> maxResolution) {
        Utils.checkNotNull(maxResolution, "maxResolution");
        this.maxResolution = maxResolution;
        return this;
    }
     ...
     * The maximum duration in seconds that a live stream can have before it ends the stream.
     */
    public PatchResponseData withMaxDuration(Optional<Long> maxDuration) {
        Utils.checkNotNull(maxDuration, "maxDuration");
        this.maxDuration = maxDuration;
        return this;
    }
     ...
     * It is the moment when the stream was created Time the media was generated, defined as a localDateTime (UTC Time).
     */
    public PatchResponseData withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * It is the moment when the stream was created Time the media was generated, defined as a localDateTime (UTC Time).
     */
    public PatchResponseData withCreatedAt(Optional<OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * In case the software streaming the live, get disrupted for any reason and get disconnect from FastPix, the reconnect window specifies the waiting time span of FastPix will wait before ending the stream. Before starting the stream, you can set the reconnect window time set which is up to 1800 seconds.
     */
    public PatchResponseData withReconnectWindow(Optional<Long> reconnectWindow) {
        Utils.checkNotNull(reconnectWindow, "reconnectWindow");
        this.reconnectWindow = reconnectWindow;
        return this;
    }
     ...
     * When set to true, the livestream will be recorded and stored for later viewing purposes. If set to false, the livestream will not be recorded.
     */
    public PatchResponseData withEnableRecording(Optional<Boolean> enableRecording) {
        Utils.checkNotNull(enableRecording, "enableRecording");
        this.enableRecording = enableRecording;
        return this;
    }
     ...
     * Determines whether the recorded stream should be publicly accessible or private in Live to VOD (Video on Demand).
     */
    public PatchResponseData withMediaPolicy(String mediaPolicy) {
        Utils.checkNotNull(mediaPolicy, "mediaPolicy");
     ...
     * Determines whether the recorded stream should be publicly accessible or private in Live to VOD (Video on Demand).
     */
    public PatchResponseData withMediaPolicy(Optional<String> mediaPolicy) {
        Utils.checkNotNull(mediaPolicy, "mediaPolicy");
        this.mediaPolicy = mediaPolicy;
        return this;
    }
     ...
     * You can search for videos with specific key value pairs using metadata, when you tag a video in "key":"value"s pairs. Dynamic Metadata allows you to define a key that allows any value pair. You can have maximum of 255 characters and upto 10 entries are allowed.
     */
    public PatchResponseData withMetadata(Optional<? extends PatchResponseDataMetadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }

    public PatchResponseData withPlaybackId(List<PlaybackIds> playbackId) {
        Utils.checkNotNull(playbackId, "playbackId");
        this.playbackId = Optional.ofNullable(playbackId);
        return this;
    }

    public PatchResponseData withPlaybackId(Optional<? extends List<PlaybackIds>> playbackId) {
        Utils.checkNotNull(playbackId, "playbackId");
        this.playbackId = playbackId;
        return this;
    }
     ...
     * This object contains the livestream playback response details for SRT Protocol.
     */
    public PatchResponseData withSrtPlaybackResponse(Optional<? extends PatchResponseDataSrtPlaybackResponse> srtPlaybackResponse) {
        Utils.checkNotNull(srtPlaybackResponse, "srtPlaybackResponse");
        this.srtPlaybackResponse = srtPlaybackResponse;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<Long> reconnectWindow = Optional.empty();
 
        private Optional<Boolean> enableRecording = Optional.empty();
 
        private Optional<String> mediaPolicy = Optional.empty();
 
        private Optional<? extends PatchResponseDataMetadata> metadata = Optional.empty();
 
        private Optional<? extends List<PlaybackIds>> playbackId = Optional.empty();
 
        private Optional<? extends PatchResponseDataSrtPlaybackResponse> srtPlaybackResponse = Optional.empty();
         ...
         * You can search for videos with specific key value pairs using metadata, when you tag a video in "key":"value"s pairs. Dynamic Metadata allows you to define a key that allows any value pair. You can have maximum of 255 characters and upto 10 entries are allowed.
         */
        public Builder metadata(PatchResponseDataMetadata metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = Optional.ofNullable(metadata);
            return this;
        }
         ...
         * You can search for videos with specific key value pairs using metadata, when you tag a video in "key":"value"s pairs. Dynamic Metadata allows you to define a key that allows any value pair. You can have maximum of 255 characters and upto 10 entries are allowed.
         */
        public Builder metadata(Optional<? extends PatchResponseDataMetadata> metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = metadata;
            return this;
        }
         ...
         * This object contains the livestream playback response details for SRT Protocol.
         */
        public Builder srtPlaybackResponse(PatchResponseDataSrtPlaybackResponse srtPlaybackResponse) {
            Utils.checkNotNull(srtPlaybackResponse, "srtPlaybackResponse");
            this.srtPlaybackResponse = Optional.ofNullable(srtPlaybackResponse);
            return this;
        }
         ...
         * This object contains the livestream playback response details for SRT Protocol.
         */
        public Builder srtPlaybackResponse(Optional<? extends PatchResponseDataSrtPlaybackResponse> srtPlaybackResponse) {
            Utils.checkNotNull(srtPlaybackResponse, "srtPlaybackResponse");
            this.srtPlaybackResponse = srtPlaybackResponse;
            return this;
        }
