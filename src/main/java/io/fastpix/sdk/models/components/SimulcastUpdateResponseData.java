...
public class SimulcastUpdateResponseData {
    ...
    private Optional<? extends SimulcastUpdateResponseMetadata> metadata;
    ...
    public SimulcastUpdateResponseData(
            ...
            @JsonProperty("metadata") Optional<? extends SimulcastUpdateResponseMetadata> metadata) {
    ...
    @JsonIgnore
    public Optional<SimulcastUpdateResponseMetadata> metadata() {
        return (Optional<SimulcastUpdateResponseMetadata>) metadata;
    }
     ...
     * When you create the new simulcast, FastPix assign a universal unique identifier which can contain a maximum of 255 characters.
     */
    public SimulcastUpdateResponseData withSimulcastId(String simulcastId) {
        Utils.checkNotNull(simulcastId, "simulcastId");
     ...
     * When you create the new simulcast, FastPix assign a universal unique identifier which can contain a maximum of 255 characters.
     */
    public SimulcastUpdateResponseData withSimulcastId(Optional<String> simulcastId) {
        Utils.checkNotNull(simulcastId, "simulcastId");
        this.simulcastId = simulcastId;
        return this;
    }
     ...
     * The RTMP hostname, combined with the application name, is crucial for connecting to third-party live streaming services and transmitting the live stream.
     */
    public SimulcastUpdateResponseData withUrl(String url) {
        Utils.checkNotNull(url, "url");
     ...
     * The RTMP hostname, combined with the application name, is crucial for connecting to third-party live streaming services and transmitting the live stream.
     */
    public SimulcastUpdateResponseData withUrl(Optional<String> url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
     ...
     * A unique stream key is generated for streaming, allowing the user to start streaming on any third-party platform using this key.
     */
    public SimulcastUpdateResponseData withStreamKey(String streamKey) {
        Utils.checkNotNull(streamKey, "streamKey");
     ...
     * A unique stream key is generated for streaming, allowing the user to start streaming on any third-party platform using this key.
     */
    public SimulcastUpdateResponseData withStreamKey(Optional<String> streamKey) {
        Utils.checkNotNull(streamKey, "streamKey");
        this.streamKey = streamKey;
        return this;
    }
     ...
     * When the value is set to false, the simulcast will be disabled for the given stream
     */
    public SimulcastUpdateResponseData withIsEnabled(Optional<Boolean> isEnabled) {
        Utils.checkNotNull(isEnabled, "isEnabled");
        this.isEnabled = isEnabled;
        return this;
    }
     ...
     * Arbitrary user-supplied metadata that will be included in the simulcast details. Can be used to store your own ID for a video along with the simulcast. Max:255 characters, Upto 10 entries are allowed.
     */
    public SimulcastUpdateResponseData withMetadata(Optional<? extends SimulcastUpdateResponseMetadata> metadata) {
        Utils.checkNotNull(metadata, "metadata");
        this.metadata = metadata;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends SimulcastUpdateResponseMetadata> metadata = Optional.empty();
         ...
         * Arbitrary user-supplied metadata that will be included in the simulcast details. Can be used to store your own ID for a video along with the simulcast. Max:255 characters, Upto 10 entries are allowed.
         */
        public Builder metadata(SimulcastUpdateResponseMetadata metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = Optional.ofNullable(metadata);
            return this;
        }
         ...
         * Arbitrary user-supplied metadata that will be included in the simulcast details. Can be used to store your own ID for a video along with the simulcast. Max:255 characters, Upto 10 entries are allowed.
         */
        public Builder metadata(Optional<? extends SimulcastUpdateResponseMetadata> metadata) {
            Utils.checkNotNull(metadata, "metadata");
            this.metadata = metadata;
            return this;
        }
