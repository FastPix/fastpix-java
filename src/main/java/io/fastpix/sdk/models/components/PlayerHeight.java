 ...
 * PlayerHeight
 * 
 * <p>Player Height refers to the vertical dimension, measured in pixels, of the video player as it
 * appears on the webpage.
 */
@JsonDeserialize(using = PlayerHeight._Deserializer.class)
public class PlayerHeight {

    @JsonValue
    private final TypedObject value;
    
    private PlayerHeight(TypedObject value) {
        this.value = value;
    }

    public static PlayerHeight of(String value) {
        Utils.checkNotNull(value, "value");
        return new PlayerHeight(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }

    public static PlayerHeight of(long value) {
        return new PlayerHeight(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
   ...
   public Optional<JsonNode> asJson() {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PlayerHeight other = (PlayerHeight) o;
    ...
    public static final class _Deserializer extends OneOfDeserializer<PlayerHeight> {
        ...
        public _Deserializer() {
            super(PlayerHeight.class, false,
    ...
    public String toString() {
        return Utils.toString(PlayerHeight.class,
                "value", value);
    }
