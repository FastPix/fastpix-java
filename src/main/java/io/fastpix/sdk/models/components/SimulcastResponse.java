...
public class SimulcastResponse {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("data")
    private SimulcastResponseData data;

    @JsonCreator
    public SimulcastResponse(
            @JsonProperty("success") @Nullable Boolean success,
            @JsonProperty("data") @Nullable SimulcastResponseData data) {
     ...
     * Shows the request status. Returns true for success and false for failure.
     */
    public SimulcastResponse withSuccess(@Nullable Boolean success) {
        this.success = success;
        return this;
    }
     ...
     * Displays the result of the request.
     */
    public SimulcastResponse withData(@Nullable SimulcastResponseData data) {
        this.data = data;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * Displays the result of the request.
         */
        public Builder data(@Nullable SimulcastResponseData data) {
            this.data = data;
            return this;
        }
