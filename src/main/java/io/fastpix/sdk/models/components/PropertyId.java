 ...
 * PropertyId
 * 
 * <p>Represents the unique identifier assigned to a FastPix property, which is associated with a specific
 * workspace or project. It helps link playback and analytics data to the correct property
 * configuration.
 */
@JsonDeserialize(using = PropertyId._Deserializer.class)
public class PropertyId {

    @JsonValue
    private final TypedObject value;
    
    private PropertyId(TypedObject value) {
        this.value = value;
    }

    public static PropertyId of(String value) {
        Utils.checkNotNull(value, "value");
        return new PropertyId(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
   ...
   public Optional<JsonNode> asJson() {
    ...
    public static final class _Deserializer extends OneOfDeserializer<PropertyId> {

        public _Deserializer() {
            super(PropertyId.class, false,
    ...
    public String toString() {
        return Utils.toString(PropertyId.class,
                "value", value);
    }
