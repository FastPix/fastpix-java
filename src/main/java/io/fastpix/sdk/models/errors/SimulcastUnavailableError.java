...
public class SimulcastUnavailableError {
     ...
     * An error code indicating the type of the error.
     */
    public SimulcastUnavailableError withCode(Optional<Long> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * A descriptive message providing more details for the error
     */
    public SimulcastUnavailableError withMessage(String message) {
        Utils.checkNotNull(message, "message");
     ...
     * A descriptive message providing more details for the error
     */
    public SimulcastUnavailableError withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public SimulcastUnavailableError withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public SimulcastUnavailableError withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SimulcastUnavailableError other = (SimulcastUnavailableError) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SimulcastUnavailableError.class,
                "code", code,
                "message", message,
    ...
    public final static class Builder {
        ...
        public SimulcastUnavailableError build() {
            return new SimulcastUnavailableError(
                code,
                message,
                description);
        }
