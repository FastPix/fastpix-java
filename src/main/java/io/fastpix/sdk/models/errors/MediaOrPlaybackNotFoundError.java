...
public class MediaOrPlaybackNotFoundError {
     ...
     * Displays the error code indicating the type of the error.
     */
    public MediaOrPlaybackNotFoundError withCode(Optional<Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * A descriptive message providing more details for the error.
     */
    public MediaOrPlaybackNotFoundError withMessage(String message) {
        Utils.checkNotNull(message, "message");
     ...
     * A descriptive message providing more details for the error.
     */
    public MediaOrPlaybackNotFoundError withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public MediaOrPlaybackNotFoundError withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public MediaOrPlaybackNotFoundError withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MediaOrPlaybackNotFoundError other = (MediaOrPlaybackNotFoundError) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MediaOrPlaybackNotFoundError.class,
                "code", code,
                "message", message,
    ...
    public final static class Builder {
        ...
        public MediaOrPlaybackNotFoundError build() {
            return new MediaOrPlaybackNotFoundError(
                code,
                message,
                description);
        }
