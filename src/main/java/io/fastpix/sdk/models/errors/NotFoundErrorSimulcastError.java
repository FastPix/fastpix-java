...
public class NotFoundErrorSimulcastError {
     ...
     * Displays the error code indicating the type of the error.
     */
    public NotFoundErrorSimulcastError withCode(Optional<Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * A descriptive message providing more details for the error.
     */
    public NotFoundErrorSimulcastError withMessage(String message) {
        Utils.checkNotNull(message, "message");
     ...
     * A descriptive message providing more details for the error.
     */
    public NotFoundErrorSimulcastError withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public NotFoundErrorSimulcastError withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public NotFoundErrorSimulcastError withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        NotFoundErrorSimulcastError other = (NotFoundErrorSimulcastError) o;
        return 
    ...
    public String toString() {
        return Utils.toString(NotFoundErrorSimulcastError.class,
                "code", code,
                "message", message,
    ...
    public final static class Builder {
        ...
        public NotFoundErrorSimulcastError build() {
            return new NotFoundErrorSimulcastError(
                code,
                message,
                description);
        }
