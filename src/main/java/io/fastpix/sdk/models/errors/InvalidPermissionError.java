...
public class InvalidPermissionError {
     ...
     * Displays the error code indicating the type of the error.
     */
    public InvalidPermissionError withCode(Optional<Long> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * A descriptive message providing more details for the error.
     */
    public InvalidPermissionError withMessage(String message) {
        Utils.checkNotNull(message, "message");
     ...
     * A descriptive message providing more details for the error.
     */
    public InvalidPermissionError withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public InvalidPermissionError withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public InvalidPermissionError withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        InvalidPermissionError other = (InvalidPermissionError) o;
        return 
    ...
    public String toString() {
        return Utils.toString(InvalidPermissionError.class,
                "code", code,
                "message", message,
    ...
    public final static class Builder {
        ...
        public InvalidPermissionError build() {
            return new InvalidPermissionError(
                code,
                message,
                description);
        }
