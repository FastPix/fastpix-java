...
public class MediaNotFoundError {
     ...
     * Displays the error code indicating the type of the error.
     */
    public MediaNotFoundError withCode(Optional<Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * A descriptive message providing more details for the error.
     */
    public MediaNotFoundError withMessage(String message) {
        Utils.checkNotNull(message, "message");
     ...
     * A descriptive message providing more details for the error.
     */
    public MediaNotFoundError withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public MediaNotFoundError withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public MediaNotFoundError withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MediaNotFoundError other = (MediaNotFoundError) o;
        return 
    ...
    public String toString() {
        return Utils.toString(MediaNotFoundError.class,
                "code", code,
                "message", message,
