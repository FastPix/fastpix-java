...
public class UnauthorizedError {
     ...
     * Displays the error code indicating the type of the error.
     */
    public UnauthorizedError withCode(Optional<Long> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * A descriptive message providing more details for the error.
     */
    public UnauthorizedError withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public UnauthorizedError withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public UnauthorizedError withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(UnauthorizedError.class,
                "code", code,
                "message", message,
