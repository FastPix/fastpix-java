...
public class NotFoundErrorPlaybackIdError {
     ...
     * Displays the error code indicating the type of the error.
     */
    public NotFoundErrorPlaybackIdError withCode(Optional<Double> code) {
        Utils.checkNotNull(code, "code");
        this.code = code;
        return this;
    }
     ...
     * A descriptive message providing more details for the error.
     */
    public NotFoundErrorPlaybackIdError withMessage(String message) {
        Utils.checkNotNull(message, "message");
     ...
     * A descriptive message providing more details for the error.
     */
    public NotFoundErrorPlaybackIdError withMessage(Optional<String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public NotFoundErrorPlaybackIdError withDescription(String description) {
        Utils.checkNotNull(description, "description");
     ...
     * A detailed explanation of the possible causes for the error.
     */
    public NotFoundErrorPlaybackIdError withDescription(Optional<String> description) {
        Utils.checkNotNull(description, "description");
        this.description = description;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        NotFoundErrorPlaybackIdError other = (NotFoundErrorPlaybackIdError) o;
        return 
    ...
    public String toString() {
        return Utils.toString(NotFoundErrorPlaybackIdError.class,
                "code", code,
                "message", message,
    ...
    public final static class Builder {
        ...
        public NotFoundErrorPlaybackIdError build() {
            return new NotFoundErrorPlaybackIdError(
                code,
                message,
                description);
        }
