...
public class RetrieveMediaInputInfoResponse implements Response {
     ...
     */
    private RetrieveMediaInputInfoResponseBody object;
    ...
    @JsonCreator
    public RetrieveMediaInputInfoResponse(
            @Nonnull String contentType,
            int statusCode,
            @Nonnull HttpResponse<InputStream> rawResponse,
            @Nullable RetrieveMediaInputInfoResponseBody object,
     ...
     * Get video media input information
     */
    public Optional<RetrieveMediaInputInfoResponseBody> object() {
     ...
     * HTTP response content type for this operation
     */
    public RetrieveMediaInputInfoResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RetrieveMediaInputInfoResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Get video media input information
     */
    public RetrieveMediaInputInfoResponse withObject(@Nullable RetrieveMediaInputInfoResponseBody object) {
        this.object = object;
        return this;
    }
     ...
     * responses and their status codes.
     */
    public RetrieveMediaInputInfoResponse withDefaultError(@Nullable DefaultError defaultError) {
        this.defaultError = defaultError;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RetrieveMediaInputInfoResponse other = (RetrieveMediaInputInfoResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(RetrieveMediaInputInfoResponse.class,
    ...
    public static final class Builder {
         ...
         * Get video media input information
         */
        public Builder object(@Nullable RetrieveMediaInputInfoResponseBody object) {
            this.object = object;
            return this;
        }
        ...
        public RetrieveMediaInputInfoResponse build() {
            return new RetrieveMediaInputInfoResponse(
                contentType, statusCode, rawResponse,
                object, defaultError);
        }
