...
public class ListUploadsResponse implements AsyncResponse {
     ...
     * List of video media
     */
    private ListUploadsResponseBody object;
    ...
    public ListUploadsResponse(
            ...
            @Nullable ListUploadsResponseBody object,
     ...
     * List of video media
     */
    public Optional<ListUploadsResponseBody> object() {
     ...
     * HTTP response content type for this operation
     */
    public ListUploadsResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public ListUploadsResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListUploadsResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * List of video media
     */
    public ListUploadsResponse withObject(@Nullable ListUploadsResponseBody object) {
        this.object = object;
        return this;
    }
     ...
     * responses and their status codes.
     */
    public ListUploadsResponse withDefaultError(@Nullable DefaultError defaultError) {
        this.defaultError = defaultError;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(ListUploadsResponse.class,
    ...
    public static final class Builder {
         ...
         * List of video media
         */
        public Builder object(@Nullable ListUploadsResponseBody object) {
            this.object = object;
            return this;
        }
