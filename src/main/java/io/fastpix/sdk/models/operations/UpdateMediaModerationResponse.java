...
public class UpdateMediaModerationResponse implements Response {
     ...
     */
    private UpdateMediaModerationResponseBody object;
    ...
    @JsonCreator
    public UpdateMediaModerationResponse(
            @Nonnull String contentType,
            int statusCode,
            @Nonnull HttpResponse<InputStream> rawResponse,
            @Nullable UpdateMediaModerationResponseBody object,
     ...
     * Media details updated successfully with the named entity extraction feature enabled or disabled
     */
    public Optional<UpdateMediaModerationResponseBody> object() {
     ...
     * HTTP response status code for this operation
     */
    public UpdateMediaModerationResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateMediaModerationResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Media details updated successfully with the named entity extraction feature enabled or disabled
     */
    public UpdateMediaModerationResponse withObject(@Nullable UpdateMediaModerationResponseBody object) {
        this.object = object;
        return this;
    }
     ...
     * responses and their status codes.
     */
    public UpdateMediaModerationResponse withDefaultError(@Nullable DefaultError defaultError) {
        this.defaultError = defaultError;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateMediaModerationResponse other = (UpdateMediaModerationResponse) o;
        return 
    ...
    public static final class Builder {
         ...
         * Media details updated successfully with the named entity extraction feature enabled or disabled
         */
        public Builder object(@Nullable UpdateMediaModerationResponseBody object) {
            this.object = object;
            return this;
        }
        ...
        public UpdateMediaModerationResponse build() {
            return new UpdateMediaModerationResponse(
                contentType, statusCode, rawResponse,
                object, defaultError);
        }
