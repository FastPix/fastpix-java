...
public enum GetTimeseriesDataMetricId {
    ...
    GetTimeseriesDataMetricId(String value) {
        this.value = value;
    }
    ...
    public static Optional<GetTimeseriesDataMetricId> fromValue(String value) {
        for (GetTimeseriesDataMetricId o: GetTimeseriesDataMetricId.values()) {
