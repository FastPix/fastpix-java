...
public class RetrieveMediaInputInfoResponse implements AsyncResponse {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public RetrieveMediaInputInfoResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
