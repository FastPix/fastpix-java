...
public class UpdateDomainRestrictionsRequest {
    ...
    private UpdateDomainRestrictionsRequestBody body;

    @JsonCreator
    public UpdateDomainRestrictionsRequest(
    ...
    public UpdateDomainRestrictionsRequest withMediaId(@Nonnull String mediaId) {
        this.mediaId = Utils.checkNotNull(mediaId, "mediaId");
        return this;
    }


    public UpdateDomainRestrictionsRequest withPlaybackId(@Nonnull String playbackId) {
        this.playbackId = Utils.checkNotNull(playbackId, "playbackId");
        return this;
    }


    public UpdateDomainRestrictionsRequest withBody(@Nonnull UpdateDomainRestrictionsRequestBody body) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateDomainRestrictionsRequest other = (UpdateDomainRestrictionsRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateDomainRestrictionsRequest.class,
                "mediaId", mediaId,
    ...
    public static final class Builder {
        ...
        public Builder body(@Nonnull UpdateDomainRestrictionsRequestBody body) {
            this.body = Utils.checkNotNull(body, "body");
            return this;
        }

        public UpdateDomainRestrictionsRequest build() {
            return new UpdateDomainRestrictionsRequest(
                mediaId, playbackId, body);
        }
