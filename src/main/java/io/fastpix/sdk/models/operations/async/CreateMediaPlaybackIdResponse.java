...
public class CreateMediaPlaybackIdResponse implements AsyncResponse {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateMediaPlaybackIdResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
