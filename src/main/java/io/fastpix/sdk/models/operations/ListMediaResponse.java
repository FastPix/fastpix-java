...
public class ListMediaResponse implements Response {
     ...
     * List of video media
     */
    private ListMediaResponseBody object;
    ...
    public ListMediaResponse(
            ...
            @Nullable ListMediaResponseBody object,
     ...
     * HTTP response content type for this operation
     */
    public ListMediaResponse withContentType(@Nonnull String contentType) {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListMediaResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * List of video media
     */
    public ListMediaResponse withObject(@Nullable ListMediaResponseBody object) {
        this.object = object;
        return this;
    }
     ...
     * responses and their status codes.
     */
    public ListMediaResponse withDefaultError(@Nullable DefaultError defaultError) {
        this.defaultError = defaultError;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * List of video media
         */
        public Builder object(@Nullable ListMediaResponseBody object) {
            this.object = object;
            return this;
        }
