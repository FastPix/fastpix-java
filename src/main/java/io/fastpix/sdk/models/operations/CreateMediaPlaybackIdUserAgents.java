...
public class CreateMediaPlaybackIdUserAgents {
    ...
    private Optional<? extends CreateMediaPlaybackIdUserAgentsDefaultPolicy> defaultPolicy;
    ...
    public CreateMediaPlaybackIdUserAgents(
            @JsonProperty("defaultPolicy") Optional<? extends CreateMediaPlaybackIdUserAgentsDefaultPolicy> defaultPolicy,
    ...
    @JsonIgnore
    public Optional<CreateMediaPlaybackIdUserAgentsDefaultPolicy> defaultPolicy() {
        return (Optional<CreateMediaPlaybackIdUserAgentsDefaultPolicy>) defaultPolicy;
    }
     ...
     * If set to `deny`, all user agents are denied access unless otherwise specified in the `allow` list.
     */
    public CreateMediaPlaybackIdUserAgents withDefaultPolicy(Optional<? extends CreateMediaPlaybackIdUserAgentsDefaultPolicy> defaultPolicy) {
        Utils.checkNotNull(defaultPolicy, "defaultPolicy");
        this.defaultPolicy = defaultPolicy;
        return this;
    }
     ...
     * This list is only effective when the `defaultPolicy` is set to `deny`.
     */
    public CreateMediaPlaybackIdUserAgents withAllow(List<String> allow) {
        Utils.checkNotNull(allow, "allow");
     ...
     * This list is only effective when the `defaultPolicy` is set to `deny`.
     */
    public CreateMediaPlaybackIdUserAgents withAllow(Optional<? extends List<String>> allow) {
        Utils.checkNotNull(allow, "allow");
        this.allow = allow;
        return this;
    }
     ...
     * This list is only effective when the `defaultPolicy` is set to `allow`.
     */
    public CreateMediaPlaybackIdUserAgents withDeny(List<String> deny) {
        Utils.checkNotNull(deny, "deny");
     ...
     * This list is only effective when the `defaultPolicy` is set to `allow`.
     */
    public CreateMediaPlaybackIdUserAgents withDeny(Optional<? extends List<String>> deny) {
        Utils.checkNotNull(deny, "deny");
        this.deny = deny;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateMediaPlaybackIdUserAgents other = (CreateMediaPlaybackIdUserAgents) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateMediaPlaybackIdUserAgents.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends CreateMediaPlaybackIdUserAgentsDefaultPolicy> defaultPolicy = Optional.empty();
         ...
         * If set to `deny`, all user agents are denied access unless otherwise specified in the `allow` list.
         */
        public Builder defaultPolicy(CreateMediaPlaybackIdUserAgentsDefaultPolicy defaultPolicy) {
            Utils.checkNotNull(defaultPolicy, "defaultPolicy");
            this.defaultPolicy = Optional.ofNullable(defaultPolicy);
            return this;
        }
         ...
         * If set to `deny`, all user agents are denied access unless otherwise specified in the `allow` list.
         */
        public Builder defaultPolicy(Optional<? extends CreateMediaPlaybackIdUserAgentsDefaultPolicy> defaultPolicy) {
            Utils.checkNotNull(defaultPolicy, "defaultPolicy");
            this.defaultPolicy = defaultPolicy;
            return this;
        }
        ...
        public CreateMediaPlaybackIdUserAgents build() {
            return new CreateMediaPlaybackIdUserAgents(
                defaultPolicy,
                allow,
                deny);
        }
