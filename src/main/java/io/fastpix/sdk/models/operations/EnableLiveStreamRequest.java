...
public class EnableLiveStreamRequest {
    ...
    @JsonCreator
    public EnableLiveStreamRequest(
     ...
     * Upon creating a new live stream, FastPix assigns a unique identifier to the stream.
     */
    public EnableLiveStreamRequest withStreamId(@Nonnull String streamId) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EnableLiveStreamRequest other = (EnableLiveStreamRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EnableLiveStreamRequest.class,
                "streamId", streamId);
    }
    ...
    public static final class Builder {
        ...
        public EnableLiveStreamRequest build() {
            return new EnableLiveStreamRequest(
                streamId);
        }
