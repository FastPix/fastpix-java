...
public class DirectUploadVideoMediaResponse implements AsyncResponse {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DirectUploadVideoMediaResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
