...
public class UpdateDomainRestrictionsResponse implements AsyncResponse {
     ...
     */
    private UpdateDomainRestrictionsResponseBody object;
    ...
    @JsonCreator
    public UpdateDomainRestrictionsResponse(
            @Nonnull String contentType,
            int statusCode,
            @Nonnull HttpResponse<Blob> rawResponse,
            @Nullable UpdateDomainRestrictionsResponseBody object,
     ...
     * Successfully updated domain restrictions
     */
    public Optional<UpdateDomainRestrictionsResponseBody> object() {
     ...
     * HTTP response status code for this operation
     */
    public UpdateDomainRestrictionsResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateDomainRestrictionsResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * Successfully updated domain restrictions
     */
    public UpdateDomainRestrictionsResponse withObject(@Nullable UpdateDomainRestrictionsResponseBody object) {
        this.object = object;
        return this;
    }
     ...
     * responses and their status codes.
     */
    public UpdateDomainRestrictionsResponse withDefaultError(@Nullable DefaultError defaultError) {
        this.defaultError = defaultError;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateDomainRestrictionsResponse other = (UpdateDomainRestrictionsResponse) o;
        return 
    ...
    public static final class Builder {
         ...
         * Successfully updated domain restrictions
         */
        public Builder object(@Nullable UpdateDomainRestrictionsResponseBody object) {
            this.object = object;
            return this;
        }
        ...
        public UpdateDomainRestrictionsResponse build() {
            return new UpdateDomainRestrictionsResponse(
                contentType, statusCode, rawResponse,
                object, defaultError);
        }
