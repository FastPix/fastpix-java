...
public class UpdateSpecificSimulcastOfStreamResponse implements AsyncResponse {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateSpecificSimulcastOfStreamResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
