...
public class UpdateLiveStreamDomainRestrictionsResponse implements Response {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateLiveStreamDomainRestrictionsResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
