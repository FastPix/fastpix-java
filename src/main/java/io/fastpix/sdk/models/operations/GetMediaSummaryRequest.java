...
public class GetMediaSummaryRequest {
    /**
     ...
     * The unique identifier assigned to the media when created. The value must be a valid UUID.
     */
    public GetMediaSummaryRequest withMediaId(@Nonnull String mediaId) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetMediaSummaryRequest other = (GetMediaSummaryRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetMediaSummaryRequest.class,
                "mediaId", mediaId);
    }
    ...
    public final static class Builder {
        ...
        public GetMediaSummaryRequest build() {
            return new GetMediaSummaryRequest(
                mediaId);
        }
