...
public class CreateMediaPlaybackIdDomains {
    ...
    private Optional<? extends CreateMediaPlaybackIdDomainsDefaultPolicy> defaultPolicy;
    ...
    public CreateMediaPlaybackIdDomains(
            @JsonProperty("defaultPolicy") Optional<? extends CreateMediaPlaybackIdDomainsDefaultPolicy> defaultPolicy,
    ...
    @JsonIgnore
    public Optional<CreateMediaPlaybackIdDomainsDefaultPolicy> defaultPolicy() {
        return (Optional<CreateMediaPlaybackIdDomainsDefaultPolicy>) defaultPolicy;
    }
     ...
     * If set to `deny`, all domains are denied access unless otherwise specified in the `allow` list.
     */
    public CreateMediaPlaybackIdDomains withDefaultPolicy(Optional<? extends CreateMediaPlaybackIdDomainsDefaultPolicy> defaultPolicy) {
        Utils.checkNotNull(defaultPolicy, "defaultPolicy");
        this.defaultPolicy = defaultPolicy;
        return this;
    }
     ...
     * This list is only effective when the `defaultPolicy` is set to `deny`.
     */
    public CreateMediaPlaybackIdDomains withAllow(List<String> allow) {
        Utils.checkNotNull(allow, "allow");
     ...
     * This list is only effective when the `defaultPolicy` is set to `deny`.
     */
    public CreateMediaPlaybackIdDomains withAllow(Optional<? extends List<String>> allow) {
        Utils.checkNotNull(allow, "allow");
        this.allow = allow;
        return this;
    }
     ...
     * This list is only effective when the `defaultPolicy` is set to `allow`.
     */
    public CreateMediaPlaybackIdDomains withDeny(List<String> deny) {
        Utils.checkNotNull(deny, "deny");
     ...
     * This list is only effective when the `defaultPolicy` is set to `allow`.
     */
    public CreateMediaPlaybackIdDomains withDeny(Optional<? extends List<String>> deny) {
        Utils.checkNotNull(deny, "deny");
        this.deny = deny;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateMediaPlaybackIdDomains other = (CreateMediaPlaybackIdDomains) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateMediaPlaybackIdDomains.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends CreateMediaPlaybackIdDomainsDefaultPolicy> defaultPolicy = Optional.empty();
         ...
         * If set to `deny`, all domains are denied access unless otherwise specified in the `allow` list.
         */
        public Builder defaultPolicy(CreateMediaPlaybackIdDomainsDefaultPolicy defaultPolicy) {
            Utils.checkNotNull(defaultPolicy, "defaultPolicy");
            this.defaultPolicy = Optional.ofNullable(defaultPolicy);
            return this;
        }
         ...
         * If set to `deny`, all domains are denied access unless otherwise specified in the `allow` list.
         */
        public Builder defaultPolicy(Optional<? extends CreateMediaPlaybackIdDomainsDefaultPolicy> defaultPolicy) {
            Utils.checkNotNull(defaultPolicy, "defaultPolicy");
            this.defaultPolicy = defaultPolicy;
            return this;
        }
        ...
        public CreateMediaPlaybackIdDomains build() {
            return new CreateMediaPlaybackIdDomains(
                defaultPolicy,
                allow,
                deny);
        }
