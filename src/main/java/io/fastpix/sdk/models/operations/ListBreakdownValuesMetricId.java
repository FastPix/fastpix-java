...
public enum ListBreakdownValuesMetricId {
    ...
    ListBreakdownValuesMetricId(String value) {
        this.value = value;
    }
    ...
    public static Optional<ListBreakdownValuesMetricId> fromValue(String value) {
        for (ListBreakdownValuesMetricId o: ListBreakdownValuesMetricId.values()) {
