...
public class DisableLiveStreamRequest {
    ...
    @JsonCreator
    public DisableLiveStreamRequest(
     ...
     * After creating a new live stream, FastPix assigns a unique identifier to the stream.
     */
    public DisableLiveStreamRequest withStreamId(@Nonnull String streamId) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DisableLiveStreamRequest other = (DisableLiveStreamRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DisableLiveStreamRequest.class,
                "streamId", streamId);
    }
    ...
    public static final class Builder {
        ...
        public DisableLiveStreamRequest build() {
            return new DisableLiveStreamRequest(
                streamId);
        }
