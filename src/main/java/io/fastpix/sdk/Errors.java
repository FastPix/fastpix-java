...
import io.fastpix.sdk.models.operations.ListErrorsRequestBuilder;
...
public class Errors {
    ...
    private final AsyncErrors asyncSDK;

    Errors(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.asyncSDK = new AsyncErrors(this, sdkConfiguration);
    }
     ...
     */
    public ListErrorsResponse listDirect() {
     ...
     * @throws RuntimeException subclass if the API call fails
     */
    public ListErrorsResponse list(
