...
import io.fastpix.sdk.models.operations.async.CreateSigningKeyRequestBuilder;
import io.fastpix.sdk.models.operations.async.CreateSigningKeyResponse;
import io.fastpix.sdk.models.operations.async.DeleteSigningKeyRequestBuilder;
import io.fastpix.sdk.models.operations.async.DeleteSigningKeyResponse;
import io.fastpix.sdk.models.operations.async.GetSigningKeyByIdRequestBuilder;
import io.fastpix.sdk.models.operations.async.GetSigningKeyByIdResponse;
import io.fastpix.sdk.models.operations.async.ListSigningKeysRequestBuilder;
import io.fastpix.sdk.models.operations.async.ListSigningKeysResponse;
import io.fastpix.sdk.operations.CreateSigningKey;
import io.fastpix.sdk.operations.DeleteSigningKey;
import io.fastpix.sdk.operations.GetSigningKeyById;
import io.fastpix.sdk.operations.ListSigningKeys;
import io.fastpix.sdk.utils.Headers;
import io.fastpix.sdk.utils.Options;


public class AsyncSigningKeys {
    private static final Headers _headers = Headers.EMPTY;
    private final SDKConfiguration sdkConfiguration;
    private final SigningKeys syncSDK;

    AsyncSigningKeys(SigningKeys syncSDK, SDKConfiguration sdkConfiguration) {
     ...
     * Related guide: <a href="https://fastpix.com/docs/video-security/secure-media-access-with-jwts">Create and use
     * signing keys</a>
     * 
     ...
     * @return {@code CompletableFuture<CreateSigningKeyResponse>} - The async response
     */
    public CompletableFuture<CreateSigningKeyResponse> create(@Nullable Options options) {
     ...
     * <p>Based on their creation dates, you decide to rotate those keys.
     * 
     * @return {@code CompletableFuture<ListSigningKeysResponse>} - The async response
     */
    public CompletableFuture<ListSigningKeysResponse> listDirect() {
     ...
     * @return {@code CompletableFuture<ListSigningKeysResponse>} - The async response
     */
    public CompletableFuture<ListSigningKeysResponse> list(
     ...
     */
    public CompletableFuture<DeleteSigningKeyResponse> delete(@Nonnull String signingKeyId) {
     ...
     * @return {@code CompletableFuture<DeleteSigningKeyResponse>} - The async response
     */
    public CompletableFuture<DeleteSigningKeyResponse> delete(@Nonnull String signingKeyId, @Nullable Options options) {
     ...
     * 
     * @param signingKeyId When creating the signing key, FastPix assigns a universally unique identifier with a maximum length of 255 characters. 
     * @return {@code CompletableFuture<GetSigningKeyByIdResponse>} - The async response
     */
    public CompletableFuture<GetSigningKeyByIdResponse> getById(@Nonnull String signingKeyId) {
     ...
     * @return {@code CompletableFuture<GetSigningKeyByIdResponse>} - The async response
     */
    public CompletableFuture<GetSigningKeyByIdResponse> getById(@Nonnull String signingKeyId, @Nullable Options options) {
        GetSigningKeyByIdRequest request = new GetSigningKeyByIdRequest(signingKeyId);
        AsyncRequestOperation<GetSigningKeyByIdRequest, GetSigningKeyByIdResponse> operation
              = new GetSigningKeyById.Async(
                                    sdkConfiguration, options, sdkConfiguration.retryScheduler(),
                                    _headers);
        return operation.doRequest(request)
            .thenCompose(operation::handleResponse);
