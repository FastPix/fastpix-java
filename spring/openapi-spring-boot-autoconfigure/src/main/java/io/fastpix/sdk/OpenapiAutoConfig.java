 ...
 */
@AutoConfiguration
@ConditionalOnClass(FastPixSDK.class)
...
public class OpenapiAutoConfig {
    ...
    public SecuritySource securitySource(OpenapiAutoConfigProperties properties) {OpenapiAutoConfigProperties.Security securityProps = properties.getSecurity();
        io.fastpix.sdk.models.components.Security.Builder securityBuilder = io.fastpix.sdk.models.components.Security.builder();
    ...
    public SDKConfiguration sdkConfiguration(
            ...
            io.fastpix.sdk.utils.Hooks hooks,
            io.fastpix.sdk.utils.AsyncHooks asyncHooks,
     ...
     * @return A configured FastPixSDK instance
     */
    @Bean
    @ConditionalOnMissingBean
    public FastPixSDK fastpix(SDKConfiguration sdkConfiguration) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public io.fastpix.sdk.utils.AsyncHooks asyncHooks() {
        return new io.fastpix.sdk.utils.AsyncHooks();
    }
    ...
    @Bean
    @ConditionalOnMissingBean
    public io.fastpix.sdk.utils.Hooks hooks() {
        return new io.fastpix.sdk.utils.Hooks();
    }
    /**
    ...
    @Bean
    @ConditionalOnMissingBean
    public InputVideos inputVideos(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public ManageVideos manageVideos(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public Videos videos(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AiFeatures aiFeatures(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public InVideoAiFeatures inVideoAiFeatures(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public Playback playback(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public Playlists playlists(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public Playlist playlist(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public DrmConfigurations drmConfigurations(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public Streams streams(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public ManageLiveStreams manageLiveStreams(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public ManageLiveStream manageLiveStream(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public LiveStream liveStream(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public LivePlayback livePlayback(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public LivePlaybacks livePlaybacks(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public SimulcastStream simulcastStream(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public SimulcastStreams simulcastStreams(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public Simulcasts simulcasts(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public SigningKeys signingKeys(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public Views views(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public Dimensions dimensions(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public Metrics metrics(FastPixSDK fastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public Errors errors(FastPixSDK fastpix) {
     ...
     * @param fastpix the main SDK instance
     * @param sdkConfiguration the configured SDKConfiguration bean
     * @return A configured AsyncFastPixSDK instance
     */
    @Bean
    @ConditionalOnMissingBean
    public AsyncFastPixSDK asyncFastpix(FastPixSDK fastpix, SDKConfiguration sdkConfiguration) {
        return new AsyncFastPixSDK(fastpix, sdkConfiguration);
    }
    /**
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncInputVideos asyncInputVideos(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncManageVideos asyncManageVideos(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncVideos asyncVideos(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncAiFeatures asyncAiFeatures(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncInVideoAiFeatures asyncInVideoAiFeatures(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncPlayback asyncPlayback(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncPlaylists asyncPlaylists(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncPlaylist asyncPlaylist(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncDrmConfigurations asyncDrmConfigurations(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncStreams asyncStreams(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncManageLiveStreams asyncManageLiveStreams(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncManageLiveStream asyncManageLiveStream(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncLiveStream asyncLiveStream(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncLivePlayback asyncLivePlayback(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncLivePlaybacks asyncLivePlaybacks(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncSimulcastStream asyncSimulcastStream(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncSimulcastStreams asyncSimulcastStreams(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncSimulcasts asyncSimulcasts(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncSigningKeys asyncSigningKeys(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncViews asyncViews(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncDimensions asyncDimensions(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncMetrics asyncMetrics(AsyncFastPixSDK asyncFastpix) {
    ...
    @Bean
    @ConditionalOnMissingBean
    public AsyncErrors asyncErrors(AsyncFastPixSDK asyncFastpix) {
