...
<!-- UsageSnippet language="java" operationID="create-media" method="post" path="/on-demand" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="direct-upload-video-media" method="post" path="/on-demand/upload" -->
```java
package hello.world;
